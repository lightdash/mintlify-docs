...
[**Metrics**](/get-started/build-your-semantic-layer/create-metrics)
...
[**Dimensions**](/get-started/build-your-semantic-layer/create-dimensions)
...
[**Tables**](/get-started/build-your-semantic-layer/add-tables-to-lightdash)
...
- Business users can [explore metrics quickly in the Metrics Catalog](/explore/metrics-catalog), a metrics-first experience curated by your data team
- For more complex queries, [query directly from tables](/get-started/explore-your-data/use-explores) to select metrics and dimensions without needing to know the underlying data structure
...
- Ask questions instead of building queries. [Lightdash offers an AI chat feature](/agents), or you can build your own integrations
...
AI agents can propose changes back to your semantic layer, like new metrics, dimensions, or refinements to existing definitions. See [AI writeback (beta)](/agents/ai-writeback#ai-writeback-beta) for details.
