...
description: "Generate Tables from your dbt models with the Lightdash CLI, preview and deploy them, and configure which models appear in Lightdash."
...
<Frame>
  <img src="/images/get-started/build-your-semantic-layer/add-tables-to-lightdash/overview-tables.png" />
</Frame>
...
<Frame>
  <img src="/images/get-started/build-your-semantic-layer/add-tables-to-lightdash/adding-tables-orders.png" alt="Example image showing orders table in Lightdash" width="400"/>
</Frame>

You can read more about [Lightdash preview environments here](/workflow/preview-projects).
...
We don't recommend using `lightdash deploy` from the CLI after initial project setup. It's better to have an [automated process like GitHub Actions](/workflow/set-up-ci-cd#deploy-changes-to-lightdash) that pushes code changes in your dbt project into Lightdash. 
...
![](/images/get-started/build-your-semantic-layer/add-tables-to-lightdash/tables-config-settings.png)
...
Once you're happy with which Tables are showing up in Lightdash, you can [add configurations to your Tables](/semantic-layer/tables) like:

* Changing how the Table name appears in Lightdash (using the `labels` config)

* Accessing dimensions and metrics from multiple tables in an explore by [joining your Table to other Tables](/semantic-layer/tables) (using the `joins` config)
...
<Frame>
  <img src="../../images/get-started/build-your-semantic-layer/add-tables-to-lightdash/table-selection-prod.png"/>
</Frame>
...
<Frame>
  <img src="/images/get-started/build-your-semantic-layer/add-tables-to-lightdash/dbt-repo-example.png" alt="" />
</Frame>
