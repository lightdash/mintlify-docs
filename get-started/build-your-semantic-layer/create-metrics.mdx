...
You can [see the full list of metric types](/semantic-layer/metrics#metric-types) that you can use in your Lightdash project.
...
![](../../images/get-started/build-your-semantic-layer/create-metrics/metrics-explore-view.png)
...
You can [see all of the metric configurations in our metrics reference doc here](/semantic-layer/metrics#metric-configuration).
...
To read more about custom metrics, take a look at [how to create custom fields](/explore/create-custom-fields).

## Check out our [metrics reference sheet](/semantic-layer/metrics) for more details