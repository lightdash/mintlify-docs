...
![](../../images/get-started/build-your-semantic-layer/create-dimensions/add-new-dimension-overview.png)
...
The name of the dimension is `source` and the type will be inferred from the column in your database. You can see the [full list of dimension types supported in Lightdash here](/semantic-layer/dimensions#dimension-types).
...
![](../../images/get-started/build-your-semantic-layer/create-dimensions/dimensions-in-the-explore-view.png)
...
<Info>
  **This tutorial assumes you've set up the Lightdash CLI.**
  ...
  If you haven't installed the Lightdash CLI yet, then [follow this guide to installing and setting it up](/workflow/cli/install).
</Info>
...
[Developer previews](/workflow/preview-projects) are temporary Lightdash projects where you can safely experiment with your metrics, dimensions and charts without affecting your production project.
...
You can [see all of the dimension configurations in our dimensions reference doc here](/semantic-layer/dimensions#dimension-configuration).
...
## See the [dimensions reference doc](/semantic-layer/dimensions) for more information about setting up your dimensions

In the [reference doc](/semantic-layer/dimensions) you'll find all of the dimension types, configurations, and more.