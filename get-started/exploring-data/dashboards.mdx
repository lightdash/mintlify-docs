...
As your dashboard grows you may find it supporting different teams and varied use-cases or domains. Lets add tabs to your dashboard for better organization!

While editing, click "Add tile" and then "Add tab".

<Frame>
  <img src="/images/get-started/exploring-data/tabs-new" alt="" />
</Frame>
...
To edit a tab, click on the edit icon to the right of your tab name while in edit mode. You can either rename or remove the tab from your dashboard.
...
<Frame>
  <img src="/images/get-started/exploring-data/tabs-transfer.png" alt="" />
</Frame>
