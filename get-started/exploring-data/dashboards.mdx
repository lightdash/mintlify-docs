...
<Frame>
  <img
    src="/images/get-started/exploring-data/dashboards/create-a-new-dashboardd.png"
    alt=""
  />
</Frame>
...
To learn more about adding filters to your dashboards, check out our guide on [using filters](/guides/limiting-data-using-filterss).
