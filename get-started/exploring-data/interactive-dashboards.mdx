...
<Info>
See the [Date zoom guide](/guides/date-zoom) for complete documentation, including how to create date zoom controls, configure available granularities, set defaults, and use custom granularities.
</Info>
