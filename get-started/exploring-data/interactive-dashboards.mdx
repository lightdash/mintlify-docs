...
<Info>
You can also disable the `Add filters` button the same way - head to edit mode and click the 'x' on the `Add filters` dropdown. This restricts end users to only using filters that have been specifically set up in dashboard edit mode. See [Adding temporary filters to your dashboard](/guides/limiting-data-using-filters#adding-temporary-filters-to-your-dashboard) for more details.
</Info>
