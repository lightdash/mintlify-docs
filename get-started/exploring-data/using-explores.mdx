...
You can control how NULL values are sorted using the `nullsFirst` parameter in the sort interface. This allows you to specify whether NULL values should appear first, last, or use your database's default sorting behavior.
...
2. For each sort field, use the NULL sorting control to select your preference:
   ...
   - **Database default** - Uses your database's default NULL sorting behavior
