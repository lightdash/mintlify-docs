...
This global search feature matches content from everywhere in the project. You can search for dashboards, charts, spaces, tables, and fields by their names and descriptions. You can also jump directly to settings pages you have access to (for example, typing "sso", "tokens", or "ask ai" surfaces the matching settings pages). It is now more powerful, with the ability to filter results and group them for easier navigation.
