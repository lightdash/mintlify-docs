...
<Frame>
  <img src="/images/get-started/exploring-data/home-page.png" width="80%" />
</Frame>

You can always get back to your homepage by clicking on the Lightdash icon in the top-left corner of your screen.

<Frame>
  <img src="/images/get-started/exploring-data/return-to-homepage.png" width="50%" alt="" />
</Frame>
...
<Frame>
  <img src="/images/get-started/exploring-data/browse.png" with="50%" alt="" />
</Frame>
...
Read more in this guide on [querying from tables in Lightdash](/get-started/exploring-data/using-explores).

<Frame>
  ![](/images/get-started/exploring-data/new-query-from-tables-two.png)
</Frame>