...
```
# schema.ymlversion: 2models:  - name: 'orders'    description: 'A table of all orders.'    columns:      - name: 'status'        description: 'Status of an order: ordered/processed/complete'      - name: 'order_id'        meta:          metrics:            total_order_count:              type: count_distinct      - name: 'order_value'        meta:          metrics:            total_sales:              type: sum
```
...
![](/assets/images/metrics-explore-view-ad313b7e515ef1dbd6898a95198f7106.jpg)
...
```
# schema.ymlversion: 2models:  - name: 'orders'    columns:      - name: 'status'      - name: 'order_id'        meta:          metrics:            total_order_count:              type: count
```
...
```
version: 2models:  - name: "orders"    description: "A table of all orders."    columns:      - name: "status"        description: "Status of an order: ordered/processed/complete"      - name: "order_value"        meta:          metrics:            total_sales:              type: sum              label: "Total sales (USD)"              groups: ["Sales metrics"]              round: 2              ...etc.
```
...
[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/get-started/setup-lightdash/how-to-create-metrics.mdx)
