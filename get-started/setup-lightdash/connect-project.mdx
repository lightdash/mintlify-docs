...
<Info>
  This authentication method is only available with a Lightdash license key, contact us for more details.
</Info>
...
And share it with us so we can enable Snowflake SSO on your environment. 
