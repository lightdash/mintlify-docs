...
**5. Allow Lightdash to reach the bastion.** Add Lightdash's [static IP addresses](/get-started/setup-lightdash/connect-project#adding-lightdashs-static-ip-addresses-to-your-allow-list) to the bastion's security group on the SSH port you configured.
