...
<Steps>
  ...
  <Step title="Data-source picker (`/onboarding/data-source`)">
    ...
    Not the person who owns the warehouse credentials? Use **Invite a teammate to connect the warehouse** — see [Handing warehouse connect to a teammate](#handing-warehouse-connect-to-a-teammate) below.
  </Step>
