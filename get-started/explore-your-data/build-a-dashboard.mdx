...
1. [Create a new dashboard](/get-started/explore-your-data/build-a-dashboard#create-a-new-dashboard)
2. [Add charts to your dashboard](/get-started/explore-your-data/build-a-dashboard#add-a-chart-to-your-dashboard)
3. [Add markdown or other content](/get-started/explore-your-data/build-a-dashboard#add-markdown-or-other-content)
4. [Save your dashboard](/get-started/explore-your-data/build-a-dashboard#save-your-dashboard)
5. [Add filters to your dashboards](/get-started/explore-your-data/build-a-dashboard#add-filters)
6. [Add tabs to your dashboard](/get-started/explore-your-data/build-a-dashboard#add-tabs)
7. [Share your dashboard](/get-started/explore-your-data/build-a-dashboard#share-your-dashboard)
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/create-a-new-dashboard.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/start-building-your-dashboard.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/create-chart-within-dashboard.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/move-chart-to-space.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/dashboard-add-saved-chart.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/dashboard-logo.png"
    alt=""
  />
</Frame>
...
To make images scale properly when dashboards resize, use inline CSS styles with responsive properties. This prevents images from getting stretched or distorted on different screen sizes.
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/markdown-background.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/dashboard-click-edit-button-f3a760accf81131d4ad0a82aac61d3e3.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/dashboard-add-new-filter-c9cea416d3d904ae2b920a2d35124f3d.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/dashboard-add-new-filter-and-select-value-39074c9eb5e02a6ce879858d14d45c3c.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/dashboard-new-filter-applied-0fe0a86f0e67452ff6ad5fa4800fe99c.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/disabled-filters-6bdc9f6be83608f202cb95ccb84e2a76.png"
    alt=""
  />
</Frame>
...
You can require viewers to pick a filter value before the dashboard loads. This is useful for dashboards built on large datasets, where running queries without a filter would be slow or expensive. Edit your filter and check the **"Require viewers to pick a value to load the dashboard"** checkbox.

The dashboard won't run until each viewer selects a value, and values aren't saved between visits — every viewer is prompted to choose their own. Any value you set while configuring the filter is intentionally cleared when you save the dashboard, so this option can't be combined with a default value.

<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/required-filters-f97fbc3c1bed6b308275c1e97144f3d1.png"
    alt=""
  />
</Frame>
...
<Frame>
  <img
    src="/images/get-started/explore-your-data/build-a-dashboard/locked-dashboard-baecf7fd0009441b2f70ede0d3fce46b.png"
    alt=""
  />
</Frame>

To learn more about adding filters to your dashboards, check out our guide on [using filters](/explore/filter-your-data).
...
<Frame>
  <img src="/images/get-started/explore-your-data/build-a-dashboard/tabs-new.png" alt="" />
</Frame>

Give your new tab a unique name.

<Frame>
  <img src="/images/get-started/explore-your-data/build-a-dashboard/tabs-name.png" alt="" />
</Frame>
...
<Frame>
  <img src="/images/get-started/explore-your-data/build-a-dashboard/tabs-added.png" alt="" />
</Frame>
...
<Frame>
  <img src="/images/get-started/explore-your-data/build-a-dashboard/tabs-edit.png" alt="" />
</Frame>
...
<Frame>
  <img src="/images/get-started/explore-your-data/build-a-dashboard/tabs-transfer-content.png" alt="" />
</Frame>
