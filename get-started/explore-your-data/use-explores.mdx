...
1. [**Metrics and Dimensions**](/get-started/explore-your-data/intro-metrics-dimensions) that are available on the table you selected
...
<Frame>
  ![](/images/get-started/explore-your-data/use-explores/explore-areas.png)
</Frame>
...
<Frame>
  ![](/images/get-started/explore-your-data/use-explores/select-fields.png)
</Frame>
...
<Frame>
  ![](/images/get-started/explore-your-data/use-explores/add-filter.png)
</Frame>
...
<Frame>
  ![](/images/get-started/explore-your-data/use-explores/sort-results.png)
</Frame>

If you want to sort by multiple fields, click the blue pill that displays the current sort, then choose `+ Add sort`.

<Frame>
  ![](/images/get-started/explore-your-data/use-explores/sort-multiple.png)
</Frame>
...
![Sort Null Values Pn](/images/get-started/explore-your-data/use-explores/sort-null-values.png)
...
You can read more about [all the chart types and configurations here](/explore/chart-types).

<Frame>
  ![](/images/get-started/explore-your-data/use-explores/build-chart.png)
</Frame>
...
<Frame>
  ![](/images/get-started/explore-your-data/use-explores/save-your-chart.png)
</Frame>
...
- [Google Sheets syncs](/integrations/sync-google-sheets)
...
Saving a chart to a Space means it can be shared individually and reused across multiple dashboards. This option is also the only way to [pin a single chart to your project home page](/explore/pin-content).

You'll get a nice **Saved chart view** that you can use to share with others.

<Frame>
  ![](/images/get-started/explore-your-data/use-explores/saved-chart.png)
</Frame>
...
<Frame>
  ![](/images/get-started/explore-your-data/use-explores/change-chart-explore.png)
</Frame>
