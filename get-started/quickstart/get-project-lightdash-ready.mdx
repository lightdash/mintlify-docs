...
<Frame>
  <img src="/images/get-started/quickstart/get-project-lightdash-ready/overview-intro-4debf555ace1283cfc3328617f044db1.png" alt="" />
</Frame>
...
<Accordion title="Don't have NodeJS/NPM installed in your system?">
  ...
  Running the command above should output something like `24.0.0` which means you've succesfully installed NodeJS/NPM <Icon icon="party-horn" iconType="solid" />
...
<Frame>
  <img src="/images/get-started/quickstart/get-project-lightdash-ready/example-table.png" />
</Frame>
...
<Frame>
  <img src="/images/get-started/quickstart/get-project-lightdash-ready/update-your-project-connection-settings.png" alt="" />
</Frame>
