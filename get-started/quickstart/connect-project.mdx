...
A Postgres or Athena project can also query more than one warehouse. See [multiple warehouse connections](/workspace-admin/multiple-warehouse-connections).
