...
We recommend you connect to Github using OAuth. This gives Lightdash a direct connection to the repo, so it won't lose access when individuals leave the company, and it can create pull requests, which is required for [dbt write-back features](/semantic-layer/dbt/write-back). This connection lives at the organization level, so you can map different dbt project repos to each Lightdash project without needing a new access token. 
...
<Check>
  After adding your Github information, fill out the [dbt project details](/semantic-layer/dbt/projects#dbt-project-settings) and you're all set!
</Check>
...
<Check>
  After adding your Gitlab information, fill out the [dbt project details](/semantic-layer/dbt/projects#dbt-project-settings) and you're all set!
</Check>
...
<Check>
  After adding the Azure DevOps details, fill out the [dbt project details](/semantic-layer/dbt/projects#dbt-project-settings) and you're all set!
</Check>
...
<Check>
  After adding your Bitbucket information, fill out the [dbt project details](/semantic-layer/dbt/projects#dbt-project-settings) and you're all set!
</Check>
...
* [dbt write-back features](/semantic-layer/dbt/write-back)
...
Usually, we recommend swapping to a direct connection to your git repo after initial project creation, but if you want to continue managing deployments in the CLI, [read this guide on how to use Lightdash deploy and set up continuous deployment](https://docs.lightdash.com/workflow/cli/deploy).
