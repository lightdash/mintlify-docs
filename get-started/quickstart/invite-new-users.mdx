...
You then need to input the email address of the user you want to invite and select the role you want to assign them. [Read more about user roles and permissions in Lightdash here](/references/workspace/roles).
