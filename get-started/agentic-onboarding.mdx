---
title: "Agentic onboarding with Aurora"
sidebarTitle: "Agentic onboarding"
description: Sign up, connect a warehouse, and chat with Aurora before any dbt models exist
tag: "Beta"
---

<Info>
  <Badge icon="flask" color="purple" size="sm" shape="pill">Beta</Badge> Agentic onboarding is gated by a feature flag. Contact Lightdash
  support to enable it for your organization or instance. [What Beta means](/support/feature-maturity-levels).
</Info>
...
If you already have a dbt project you want to connect, use the standard [Quickstart](/get-started/quickstart) instead.
...
- Provisioning is **non-throwing**. If it fails for any reason, project creation still succeeds and you can create an agent manually from [Set up agents](/agents/set-up-agents).
...
You can turn SQL mode off later once you've built explores; see [Data access](/agents/data-access) for how SQL mode interacts with agent permissions.
...
- Add more agents or customize Aurora from [Set up agents](/agents/set-up-agents).
- Build out the dbt project and semantic layer either by running the coding-agent prompt above, or by following the [Quickstart](/get-started/quickstart).
- Invite the rest of your team — see [Invite your team](/get-started/quickstart/invite-new-users).
