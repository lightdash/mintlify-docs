---
title: "How to create dimensionsAdding dimensions"
---
...
### Option 1: Create dimensions in Lightdash using the CLI command `lightdash generate -s my_model`[](#option-1-create-dimensions-in-lightdash-using-the-cli-command-lightdash-generate--s-my%5Fmodel "Direct link to option-1-create-dimensions-in-lightdash-using-the-cli-command-lightdash-generate--s-my_model")
