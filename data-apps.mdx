...
Data apps also power reusable custom chart types, which are built and managed in the chart type gallery rather than here. See [Custom project charts](/visualizations/chart-studio).
