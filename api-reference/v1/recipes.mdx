...
<Warning>
  This page includes a few of the most common API recipes, but it’s not a complete list.\
  For all available recipes, see the full collection [here](https://github.com/lightdash/lightdash-api-examples).
</Warning>
...
This does not update conditional formatting, reference lines, dashboards, dashboard filters, or charts inside dashboards.
...
- **Node.js** installed
- The old and new model names
- A copy of [rename_models_in_charts.js](https://github.com/lightdash/lightdash-api-examples/blob/main/javascript/rename_models_in_charts.js)
