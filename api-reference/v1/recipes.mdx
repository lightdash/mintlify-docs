...
1. **Node.js** installed
2. A [**Personal Access Token (PAT)**](https://docs.lightdash.com/references/personal_tokens)
3. The project UUID you want to modify
...
- A [Personal Access Token (PAT)](https://docs.lightdash.com/references/personal_tokens)
- Your Lightdash instance URL
- The project UUID you want to analyze
