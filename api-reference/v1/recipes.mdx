---
title: "Recipes"
description: "Copy-paste examples that combine Lightdash API endpoints into common workflows"
doc-type: reference
---
...
- A [Personal Access Token (PAT)](https://docs.lightdash.com/personal-settings/create-personal-tokens#personal-access-tokens)
...
<Info>
  Field-level tags are set in your dbt YAML under individual metrics and dimensions. See the [metrics reference](/semantic-layer/metrics#tags) and [dimensions reference](/semantic-layer/dimensions#tags) for syntax details.
</Info>
