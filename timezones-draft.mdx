...
If you need a precise time-of-day filter (e.g., "events after 9am on March 15"), use the timestamp filter and set the time explicitly. The picker shows your project timezone next to the time field so there's no guessing.
...
<Frame>
  <img src="/images/guides/developer/timezones/chart-timezone-picker-light.png" alt="Chart timezone picker showing Project timezone, User timezone, and a specific timezone option" className="block dark:hidden" />
  <img src="/images/guides/developer/timezones/chart-timezone-picker-dark.png" alt="Chart timezone picker showing Project timezone, User timezone, and a specific timezone option" className="hidden dark:block" />
</Frame>
