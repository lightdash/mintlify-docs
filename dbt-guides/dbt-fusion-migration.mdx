...
Lightdash CLI works seamlessly with dbt Fusion because Fusion projects follow the dbt 1.10+ project structure. You can run Fusion locally, and Lightdash CLI commands will still work because Lightdash never executes your dbt code; it simply uses your project metadata to compile queries.
