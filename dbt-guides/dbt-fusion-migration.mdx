---
title: 'Migrating to dbt Fusion: Complete Migration Guide'
...
Once all deprecation warnings are resolved, dbt Core users will need to follow the steps below to migrate to the dbt Fusion engine. dbt Cloud users, however can wait for automatic rollout - dbt Labs will handle the fusion migration automatically. 
