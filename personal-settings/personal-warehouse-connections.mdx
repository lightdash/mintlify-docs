...
- **Sign in with AWS**: Use your AWS IAM Identity Center account to authenticate in the browser. This requires the project connection to be configured with AWS IAM Identity Center settings. See [Redshift connection setup](/get-started/quickstart/connect-project#setting-up-aws-iam-identity-center-for-redshift) for details.
