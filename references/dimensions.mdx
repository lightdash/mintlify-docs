...
<Info>
  **Availability:** The `convert_timezone` dimension override is a [Beta](/references/workspace/feature-maturity-levels) feature. It requires the [project query timezone](/guides/developer/timezones#project-query-timezone-ui-setting) to be set.
</Info>
