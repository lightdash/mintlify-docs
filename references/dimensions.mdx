...
Column descriptions in your YAML file are automatically pulled into Lightdash and you can spot them if you hover over the dimension name <Icon icon="eyes" iconType="solid"/>
...
| $\{ row.table\_name.column\_name.formatted } | The exact value of the column as seen in the Lightdash UI. For example "$1,427.20"           |
