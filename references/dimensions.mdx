...
| [required\_attributes](#required-attributes) | No       | Object with \{ user\_attribute, value }                                                                                                        | Limits access to users with those attributes                                                                                                                                                                                                               |
...
<Accordion title="(Legacy) format, round, and compact options">
...
**[Formatting](#format) added to a date or timestamp dimension will be applied to all of the time intervals for that dimension.**
