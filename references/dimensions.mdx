...
<Info>
  **Availability:** The `convert_timezone` dimension override is an [Experimental](/references/workspace/feature-maturity-levels) feature - contact support to enable it for your organization. Has no effect unless the [project query timezone](/guides/developer/timezones#project-query-timezone-ui-setting) is set.
</Info>
