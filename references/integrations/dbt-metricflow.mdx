...
<Info>
  **Beta:** MetricFlow support is currently in the [Beta](/references/workspace/feature-maturity-levels) phase. Behavior and supported features may change as we iterate.
</Info>
...
- **[dbt Cloud connection](/get-started/setup-lightdash/connect-project#dbt-cloud)** — Lightdash pulls your semantic models and metrics from the dbt Cloud Discovery API when you refresh the project. See [Using the dbt Cloud connection](#using-the-dbt-cloud-connection) for details and limitations.
