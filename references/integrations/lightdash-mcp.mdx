...
The assistant will call `create_scheduled_delivery` with the chart's slug, the cron schedule, and the Slack destination — mirroring the [AI agent](/guides/ai-agents) `createScheduledDelivery` tool but exposed to any MCP client.
