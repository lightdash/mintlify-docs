...
You can customize the tooltip on your charts to show all the information you need. 

To enable this feature, go to **chat config \>  display \>  and enable custom tooltip**. You can add HTML code to display . Javascript is not allowed for security reasons. 

![Custom Tooltip Html Pn](/images/custom-tooltip-html.png)

You can also select variables from your chart, from any of the axes, even on grouped charts. Start typing the name of the field, and we'll autocomplete with the right variables and generate the code.![Custom Tooltip Variable Gi](/images/custom-tooltip-variable.gif)

This tooltip will show up on saved charts, dashboards, and it will be included on the **dashboards as code** downloads.
