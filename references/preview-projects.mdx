...
If you haven't changed anything from our default [GitHub action script](https://github.com/lightdash/cli-actions/blob/main/start-preview.yml), then the connection settings used for your preview project should be whatever you've specified in your [DBT\_PROFILES secret](/guides/cli/how-to-use-lightdash-preview#dbt%5Fprofiles).
...
### Lightdash App[](#lightdash-app-2 "Direct link to Lightdash App")
