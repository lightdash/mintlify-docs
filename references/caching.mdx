...
2. [Cached results for Charts and Dashboards](#chart-and-dashboard-results-caching) - beta feature that must be enabled by the Lightdash team. This feature is only available for Pro, Enterprise, and on-prem users since it requires a dedicated Lightdash instance.
