...
| `ld-dashboard-guided-setup`        | The guided setup card shown while [required filters or requirement groups](/guides/limiting-data-using-filters#required-filters-and-filter-requirement-groups) are unmet |
