...
3. Copy the palette UUID for the palette you want to use
...
### Retrieving available palettes

You can fetch the list of available color palettes from the API:

```
GET /api/v1/org/color-palettes
```

Use the returned palette UUIDs to dynamically select which palette to apply.
