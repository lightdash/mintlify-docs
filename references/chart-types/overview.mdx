...
- [Data app visualization](/guides/data-apps/visualizations)

Data app visualizations are AI-generated custom chart types built with [data apps](/guides/data-apps), and require data apps to be enabled on your instance. See the [Data app visualizations guide](/guides/data-apps/visualizations) for how to create and use them.
