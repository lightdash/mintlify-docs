...
[Custom charts](/references/chart-types/custom-charts) cover two things: reusable chart types you build for your project, and one-off charts written as a Vega-Lite spec.
