...
For example, if you pivot by `created_at_month` (with 12 months of data) and have 6 metrics:
- Total columns: **12 columns** (one per month)
- Each metric appears as a row

Here's what the same data looks like with metrics as rows:

| partner_name | Metric  | Jan 2024 | Feb 2024 | Mar 2024 | ... |
|--------------|---------|----------|----------|----------|-----|
| Acme         | revenue | 1000     | 1200     | 1100     | ... |
| Acme         | orders  | 50       | 60       | 55       | ... |
| Acme         | margin  | 200      | 240      | 220      | ... |
| Beta         | revenue | 1500     | 1400     | 1600     | ... |
| Beta         | orders  | 75       | 70       | 80       | ... |
| Beta         | margin  | 300      | 280      | 320      | ... |

With 12 months, this creates only 12 columns (plus the row label columns), compared to 72 columns when metrics are columns.
