---
title: "Custom charts"
description: "Chart types beyond the built-in set: reusable chart types you build for your project, and one-off charts written as a Vega-Lite spec."
icon: "code"
---
...
<Frame>
  ![The chart type gallery, showing cards for each of the project's chart types](/images/references/chart-types/custom-chart-types-gallery.png)
</Frame>
...
<Frame>
  ![The chart type builder, with the sample-data preview, the Configure panel, and the prompt bar](/images/references/chart-types/custom-chart-types-builder.png)
</Frame>
...
<Frame>
  ![The Custom chart type picker open in the Explorer, listing the built-in Vega editor and the project's own chart types](/images/references/chart-types/custom-chart-types-picker.png)
</Frame>

The chart re-renders as you change the mapping or the underlying query.

<Frame>
  ![A project chart type selected in the Explorer, with its inputs mapped to the query's fields and the chart rendering](/images/references/chart-types/custom-chart-types-mapping.png)
</Frame>
...
![Custom funnel chart](/images/references/chart-types/custom-charts-funnel-chart.png)
...
![Custom Waterfall](/images/references/chart-types/custom-charts-waterfall.png)
...
![Custom trellis area chart](/images/references/chart-types/trellis-area.png)
