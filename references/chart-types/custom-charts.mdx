...
<Frame>
  ![The Explorer chart configuration with a project chart type selected, showing the Custom chart type picker and the field mapping](/images/references/chart-types/custom-chart-types-picker.png)
</Frame>
