...
```
https://your-instance.lightdash.cloud/embed/{projectUuid}?theme=dark&backgroundColor=1c1c1c#{jwtToken}
```
...
```
https://app.lightdash.cloud/embed/abc-123?theme=dark&backgroundColor=1c1c1c#eyJhbGci...
```
