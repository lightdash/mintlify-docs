...
## Theming URL parameters

Embedded dashboards support two optional URL parameters for customizing the visual appearance of the embed. These are added as **query parameters** before the hash fragment.

### URL format

```
https://your-instance.lightdash.cloud/embed/{projectUuid}/dashboard/{dashboardUuid}?theme=dark&backgroundColor=1c1c1c#{jwtToken}
```
...
**Example:**
```
https://app.lightdash.cloud/embed/abc-123/dashboard/my-dashboard?theme=dark#eyJhbGci...
```
...
**Example:**
```
https://app.lightdash.cloud/embed/abc-123/dashboard/my-dashboard?backgroundColor=1c1c1c#eyJhbGci...
```

### Combining both parameters

You can use `theme` and `backgroundColor` together:

```
https://app.lightdash.cloud/embed/abc-123/dashboard/my-dashboard?theme=dark&backgroundColor=1c1c1c#eyJhbGci...
```
...
const embedUrl = `${instanceUrl}/embed/${projectUuid}/dashboard/${dashboardUuid}?theme=dark&backgroundColor=1c1c1c#${token}`;
```
...
# Build embed URL with theming parameters
embed_url = f"{instance_url}/embed/{project_uuid}/dashboard/{dashboard_uuid}?theme=dark&backgroundColor=1c1c1c#{token}"
```
