...
7. Use it to login on the CLI using _lightdash login https://`your-lightdash-cloud` --token `your-token`_
...
3. Make sure you change the `yaml` on github to use your service account token _lightdash login https://`your-lightdash-cloud` --token `your-token`_
...
4. Login on the CLI using this token _lightdash login https://`your-lightdash-cloud` --token `your-token`_
