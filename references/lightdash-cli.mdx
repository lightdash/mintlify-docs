...
Download a specific scheduled delivery, alert, or Google Sheets sync by slug.
...
Download charts and dashboards only, skipping scheduler-driven content.
