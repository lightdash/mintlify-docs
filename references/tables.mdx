...
| [groups](#groups)                                         | array of strings   | Group tables in the sidebar, with up to 3 levels of nesting. [Read about groups.](#groups)                                              |
...
Use `groups` to organize tables into nested groups in the sidebar. You can nest up to **3 levels deep** by passing an array of group keys, ordered from outermost to innermost.
