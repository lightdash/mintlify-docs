...
1. This chart works best with a **time-based or categorical dimension** for the x-axis (such as year or stage) and a **numeric metric** for the y-axis (such as amount or count).