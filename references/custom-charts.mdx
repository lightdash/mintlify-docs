...
1. This chart works best when you have `latitude and longitude fields` to plot the points on the map, and optionally a `numeric metric` to adjust the size of each point (like total sales or number of customers).
