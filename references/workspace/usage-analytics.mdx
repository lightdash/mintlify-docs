...
| Trino          | Appends JSON metadata as a SQL comment in your query history.                                                                                     |
| Redshift       | Appends JSON metadata as a SQL comment in your query history.                                                                                     |
| Databricks     | Appends JSON metadata as a SQL comment in your query history.                                                                                     |
| Postgres       | Appends JSON metadata as a SQL comment in your query history.                                                                                     |
| Athena         | Appends JSON metadata as a SQL comment in your query history.                                                                                     |
| ClickHouse     | Appends JSON metadata as a SQL comment in your [query log](https://clickhouse.com/docs/operations/system-tables/query_log).                       |