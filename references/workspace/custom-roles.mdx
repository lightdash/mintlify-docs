...
- **System roles**: Pre-defined roles (like Admin, Developer, and Viewer) that come with a standard set of scopes. For more on what each one can do, check our [default system roles permission matrix](/references/roles#roles-and-permissions).
