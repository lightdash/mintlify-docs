...
When default user spaces (personal user spaces) are enabled, interactive viewers - and any other eligible users - can save charts to their own personal space. In other words, if you are asked whether interactive viewers can save charts to a personal space, the answer is **yes, as long as the default user spaces (personal user spaces) setting is turned on for the project**.
