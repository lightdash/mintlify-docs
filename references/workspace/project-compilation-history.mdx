...
If you are shaping custom roles, grant both `update:Project` and `view:JobStatus` on the project to any role that needs to read compilation logs. See [roles and permissions](/references/workspace/roles) for the full permission matrix.
