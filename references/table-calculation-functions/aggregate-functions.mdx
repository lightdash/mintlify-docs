...
![Edit Table Calculation dialog with a percent_of_total formula using total()](/images/references/table-calculation-functions/aggregate-functions-total-example.png)
