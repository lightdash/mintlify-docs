...
## Usage analytics dashboards[​](#usage-analytics-dashboards "Direct link to Usage analytics dashboards")
...
![](/assets/images/access-usage-analytics-84a955690c23e22d4a5594e76f134737.jpg)

Or you can also use our [search bar](https://docs.lightdash.com/get-sarted/exploring-data/exploring-your-content#using-the-search-bar) to get direct access to the different analytics dashboards by typing the name of the dashboard (eg: User activity)

### User Activity dashboard[​](#user-activity-dashboard "Direct link to User Activity dashboard")

This dashboard gives you an overview of the users in your project and the activity of your users.

![](/assets/images/user-activity-dashboard-e95a42bb99c5ed04f3434b1cbf9e5f4b.jpg)
...
[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/references/usage-analytics.mdx)
