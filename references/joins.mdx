...
<Info>
  **Fanout handling is an experimental feature** currently only available in Lightdash Cloud. If you would like to use it, [reach out to the Lightdahsh team](/contact/contact_info).
</Info>
