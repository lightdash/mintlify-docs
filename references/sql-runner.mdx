...
SQL runner charts on a dashbaord can be filtered in the UI. See the [filter documentation](/references/guides/limiting-data-using-filters) for more information.
