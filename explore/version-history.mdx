...
description: Roll back to earlier versions of charts and dashboards in Lightdash
---
...
<Frame>
  <img src="/images/explore/version-history/version-history.png" alt="A chart's three-dot menu open, with Version History in the list"/>
</Frame>
...
<Frame>
  <img src="/images/explore/version-history/version-history-explorer-ba442ad1aba9dbbef26fd2b7eff21eef.png" alt="The version history view, listing each previous version with its author and update time beside a preview of the selected one"/>
</Frame>
...
<Frame>
  <img src="/images/explore/version-history/version-history-selection-9a266ef03efb84ab3567e1ac80eeedab.png" alt="The three-dot menu open next to a version in the history list, with the option to restore the chart to it"/>
</Frame>
