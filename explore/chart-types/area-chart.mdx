...
<Frame>
  ![A stacked area chart, with several coloured bands piled on top of each other so the outer edge traces the combined total over time](/images/explore/chart-types/area-chart/stacked-area-chart.png)
</Frame>
...
You can see more details about area chart configurations [here](/explore/configure-charts).
