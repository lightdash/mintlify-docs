---
title: "Custom Vega charts"
sidebarTitle: "Vega-configured"
description: "One-off charts written as a Vega-Lite spec in a JSON editor, plus worked templates you can copy"
doc-type: reference
icon: "code-dots"
---

A Vega chart is a one-off chart written as a [Vega-Lite](https://vega.github.io/vega-lite/examples) spec in a JSON editor. The spec belongs to that chart alone. Pick **Custom** in the chart type menu, then choose **Vega** in the **Custom chart type** picker.

For a reusable chart type anyone in the project can apply, see [Custom project charts](/explore/chart-types/custom-project-charts).
...
<Steps>
  ...
  <Step title="Switch to Vega">
    ...
    <Frame>
    ![The chart type menu with Custom selected and the Custom chart type picker showing Vega (JSON editor) under the Built in group](/images/explore/chart-types/custom-vega-charts/custom-charts-drop-down.png)
    </Frame>
  </Step>
...
For true source-to-target flow diagrams, use the built-in [Sankey chart](/explore/chart-types/sankey). The custom template below is an escape hatch for the stacked-bar variation that shows how segment proportions shift over time on a continuous x-axis — something the built-in Sankey doesn't do.
...
<Frame>
![A sankey-style 100% stacked bar chart: two full-height stacked bars with curved ribbons connecting the matching segments across them](/images/explore/chart-types/custom-vega-charts/sankey-style-bar-chart.png)
</Frame>
...
<Frame>
![A line chart with a shaded band around the line, marking the high and low bounds of the confidence interval at each date](/images/explore/chart-types/custom-vega-charts/custom-chart-confidence-interval.png)
</Frame>
...
<Frame>
![A heatmap grid with order weeks along the x-axis and days of the week down the y-axis, each cell shaded darker for a higher order count](/images/explore/chart-types/custom-vega-charts/custom-charts-heatmap.png)
</Frame>
...
<Frame>
![A bubble plot where each point is a circle positioned by two numeric values and sized by a third metric](/images/explore/chart-types/custom-vega-charts/custom-charts-bubble-plot.png)
</Frame>
...
For standard funnels, use the built-in [Funnel chart](/explore/chart-types/funnel-chart) — it handles discrete stages with counts and stage-to-stage percentages out of the box. The custom template below is an escape hatch for styled variations the built-in chart doesn't support (e.g., custom trapezoid coloring, inline conversion-rate labels between stages).
...
<Frame>
![Custom funnel chart](/images/explore/chart-types/custom-vega-charts/custom-charts-funnel-chart.png)
</Frame>
...
<Frame>
![Custom Waterfall](/images/explore/chart-types/custom-vega-charts/custom-charts-waterfall.png)
</Frame>
...
<Frame>
![Custom trellis area chart](/images/explore/chart-types/custom-vega-charts/trellis-area.png)
</Frame>
...
<Frame>
![A bar chart where one bar is filled in an accent colour and the rest are muted, singling that category out](/images/explore/chart-types/custom-vega-charts/custom-charts-highlighted-bar.png)
</Frame>
