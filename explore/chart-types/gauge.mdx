---
title: "Gauge"
description: "Highlight a single value against a qualitative range, like performance against a target"
icon: "gauge"
doc-type: reference
---

<Frame>
  ![A gauge chart: a semicircular dial with a needle pointing at the current value, and the arc split into coloured bands for the qualitative range](/images/explore/chart-types/gauge/gauge-chart.png)
</Frame>
