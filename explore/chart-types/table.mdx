...
<Frame>
  ![A table visualization: rows of records with a header row of field names](/images/explore/chart-types/table/table-chart-278753fedbb2530cda566e2fc61cebef.png)
</Frame>
...
<Frame>
  ![A table with the row dimension values down the side, the column dimension values across the top, and a metric in each intersecting cell](/images/explore/chart-types/table/columns-rows-metrics-example-97f2fbed98971241dde62c993fa6df8e.jpg)
</Frame>
...
<Frame>
![Tinybars Config Pn](/images/explore/chart-types/table/tinybars-config.png)
</Frame>
...
<Frame>
  ![A pivoted table where a dimension moved into the column section spreads its values across the header row](/images/explore/chart-types/table/pivoted-table-72daaf2e205221bd425e61dd1b6dc883.jpg)
</Frame>

You can move up to 3 dimensions as columns.

### Configuring pivot rows

The pivot configuration panel has three lists — **Columns**, **Rows**, and **Metrics** — that control what appears on the row axis and in what order.

- **Rows** accepts dimensions, and (when a pivot is configured) metrics and table calculations. A metric or table calculation in **Rows** renders once per row, showing its value from the first pivot column group instead of repeating in every column group.
- Drag between the lists to move fields, and drag within a list to reorder — the order in **Rows** is the order the row-axis columns render. Toggle a field's eye icon to [hide it](#hidden-dimensions-and-sorting) without removing it from the query.

Placing a metric or table calculation in **Rows** is the key to cohort-style layouts — combined with [color ranges](#color-ranges), it produces retention heatmaps like this:

<Frame>
<img
  alt="Cohort retention pivot table with a metric configured on the row axis and months across the columns"
  className="block dark:hidden"
  src="/images/explore/chart-types/table/pivot_rows_cohort_retention_light.png"
/>
</Frame>
<Frame>
<img
  ...
  src="/images/explore/chart-types/table/pivot_rows_cohort_retention_dark.png"
/>
</Frame>
...
<Frame>
  ![Screenshot 2026 06 22 At 17 14 22](/images/Screenshot-2026-06-22-at-17.14.22.png)
</Frame>
...
<Note>
  Header-click sorting is only available in edit mode and only on pivot tables. Flat (non-pivoted) tables use the sort pill above the chart — see the [Explore sort menu](/explore/explore-view#sort-results). Saved charts and dashboard tiles render with the sort that was saved.
</Note>
...
<Frame>
<img
  alt="Pivot column limit example"
  className="block dark:hidden"
  src="/images/explore/chart-types/table/pivot_column_limit_example_1_light.png"
/>
</Frame>
<Frame>
<img
  alt="Pivot column limit example"
  className="hidden dark:block"
  src="/images/explore/chart-types/table/pivot_column_limit_example_1_dark.png"
/>
</Frame>
...
<Frame>
<img
  alt="Pivot column limit exceeded"
  className="block dark:hidden"
  src="/images/explore/chart-types/table/column_limit_exceeded_light.png"
/>
</Frame>
<Frame>
<img
  alt="Pivot column limit exceeded"
  className="hidden dark:block"
  src="/images/explore/chart-types/table/column_limit_exceeded_dark.png"
/>
</Frame>
...
<img
  alt="Metrics as rows"
  className="block dark:hidden"
  src="/images/explore/chart-types/table/metrics_as_rows_light.png"
/>
</Frame>
<Frame>
<img
  alt="Metrics as rows"
  className="hidden dark:block"
  src="/images/explore/chart-types/table/metrics_as_rows_dark.png"
/>
</Frame>
...
<Frame>
  ![A table of monthly anonymous device counts whose total row is lower than the sum of the values above it](/images/explore/chart-types/table/tables-lower-total-17b9669a5d61613bf9d9a1a800138fd7.png)
</Frame>
...
<Frame>
  ![A table with rows grouped by the first dimension and a subtotal row closing out each group](/images/explore/chart-types/table/subtotals-69de33b7bb4a868d33b713d61002a782.png)
</Frame>
...
<Frame>
  ![Group Repeated Row Values](/images/group-repeated-row-values.png)
</Frame>
...
<Frame>
![A wide table with the first columns frozen to the left, marked by the lock icon in their headers, while the rest scroll](/images/explore/chart-types/table/table-freeze-column.png)
</Frame>
...
<Frame>
![A column header edge being dragged sideways, widening the column as the neighbouring ones shift](/images/explore/chart-types/table/resize-columns.gif)
</Frame>
...
<Frame>
![The Conditional Formatting section of the Configure tab, with a rule that colours cells meeting its condition](/images/explore/chart-types/table/conditional-formatting-d7ad3652e9381b8bf60b416a110e7760.png)
</Frame>
...
<Frame>
![A conditional formatting rule set to Range, with min and max colour pickers and the table cells shaded along the resulting colour scale](/images/explore/chart-types/table/table-conditional-format-range.png)
</Frame>
