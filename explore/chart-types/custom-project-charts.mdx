---
title: "Custom chart types (Chart Studio)"
sidebarTitle: "Custom"
...
<Steps>
  <Step title="Run the query you want to design against">
    In the Explorer, pick the dimensions and metrics the chart type needs and run the query. The results become the builder's preview data.
  </Step>
