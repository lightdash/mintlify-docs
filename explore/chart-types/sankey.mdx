---
title: "Sankey chart"
description: "Visualize flows between categories, from sources through to targets"
icon: "chart-sankey"
doc-type: reference
tag: "Beta"
---
...
<Note>
  <Badge icon="flask" color="purple" size="sm" shape="pill">Beta</Badge> We'd love your feedback on Sankey charts as we continue to improve them. [What Beta means](/support/feature-maturity-levels).
</Note>

<Frame>
![A sankey diagram: source nodes on the left joined to target nodes on the right by ribbons whose thickness scales with the metric](/images/explore/chart-types/sankey/sankey.png)
</Frame>
