...
<Frame>
  ![A bar chart with one vertical bar per category, each rising from a shared baseline so the heights can be compared directly](/images/explore/chart-types/bar-chart/bar-chart.png)
</Frame>
...
Check out more details about bar chart configurations [here](/explore/configure-charts).

## Stacked bar chart

<Frame>
  ![A stacked bar chart where each bar is divided into coloured segments, so the bar height is the total and each segment is one group's share](/images/explore/chart-types/bar-chart/stacked-bar-chart.png)
</Frame>
...
<Frame>
  ![A 100% stacked bar chart where every bar is the same full height and the coloured segments show each group's percentage of that total](/images/explore/chart-types/bar-chart/hundred-stacked-bar-chart.png)
</Frame>
...
<Frame>
  ![A horizontal bar chart with category labels down the left and bars extending to the right](/images/explore/chart-types/bar-chart/horizontal-bar-chart.png)
</Frame>
