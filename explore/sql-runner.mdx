...
<Frame>
  ![](/images/explore/sql-runner/access-sql-runner-e299a63e83e2ecb4b3b09c64f94211be.jpg)
</Frame>
...
<Frame>
  ![](/images/explore/sql-runner/sql-runner-components-60eb488682b46fb2ecedad92a2656adb.jpg)
</Frame>
...
<Frame>
  ![](/images/explore/sql-runner/query-history-3c6295f2352f2d118474de3a51d83fd7.jpg)
</Frame>
...
3. [**Write-back to dbt so your query is saved as a governed model.**](/semantic-layer/dbt/write-back)
...
<Frame>
  ![](/images/explore/sql-runner/build-chart-sql-runner-72c3e95c8e37b83f48189599e25ddba1.jpg)
</Frame>

Once you've configured your chart, you can save it, add it to a space, and add it to a dashboard by hitting `save chart`.

SQL runner charts on a dashboard can be filtered in the UI. See the [filter documentation](/explore/filter-your-data) for more information.
