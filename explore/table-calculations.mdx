...
description: "Create calculations on the fly across your results table, like running totals and window aggregations"
doc-type: tutorial
tag: "Tutorial"
---

You add table calculations in the Explore view and they appear as green columns in your results table (remember, [dimensions](/semantic-layer/dimensions) are blue, and [metrics](/semantic-layer/metrics) are orange).

<Frame>
  <img src="/images/explore/table-calculations/table-calc-results-light.png" alt="Table calculation column in the results table" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/table-calc-results-dark.png" alt="Table calculation column in the results table" className="hidden dark:block" />
</Frame>

Table calculations can be built in two ways:

- **[Formula](/explore/table-calculations/formulas)**: a spreadsheet-style syntax that reads like Google Sheets. The default mode for new table calculations.
- **SQL**: raw SQL.
...
<Frame>
  <img src="/images/explore/table-calculations/quick-calculation-menu-light.png" alt="Quick calculation menu on a metric column" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/quick-calculation-menu-dark.png" alt="Quick calculation menu on a metric column" className="hidden dark:block" />
</Frame>

To learn more about what these calculations are doing, check out the docs [here](/explore/table-calculations/sql-templates). Once the table calculation is generated you can edit it to modify the SQL query or update the format.
...
<Frame>
  <img src="/images/explore/table-calculations/create-table-calc-button-light.png" alt="+ Table calculation button in the Results header" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/create-table-calc-button-dark.png" alt="+ Table calculation button in the Results header" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/explore/table-calculations/table-calc-modal-light.png" alt="Add table calculation modal with SQL editor and inline format options" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/table-calc-modal-dark.png" alt="Add table calculation modal with SQL editor and inline format options" className="hidden dark:block" />
</Frame>
...
- **[Row functions](/explore/table-calculations/functions/row-functions)** — Access values from other rows (e.g., previous row, specific row number, lookups)
- **[Pivot functions](/explore/table-calculations/functions/pivot-functions)** — Access values across pivot columns
- **[Aggregate functions](/explore/table-calculations/functions/aggregate-functions)** — Reference column totals and row totals
...
<Frame>
  <img src="/images/explore/table-calculations/table-calc-format-light.png" alt="Format options for a table calculation" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/table-calc-format-dark.png" alt="Format options for a table calculation" className="hidden dark:block" />
</Frame>

See [Formatting table calculations](/explore/formatting-your-fields#formatting-table-calculations) for the full list of format types and their options.
...
<Frame>
  <img src="/images/explore/table-calculations/table-calc-edit-delete-light.png" alt="Edit / delete dropdown on a table calculation column header" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/table-calc-edit-delete-dark.png" alt="Edit / delete dropdown on a table calculation column header" className="hidden dark:block" />
</Frame>
...
<Frame>
![](/images/explore/table-calculations/table_calculation_filter_example.jpg)
</Frame>

## Table calculation functions and SQL templates

If you prefer not to write raw SQL, check out the built-in [row functions](/explore/table-calculations/functions/row-functions), [pivot functions](/explore/table-calculations/functions/pivot-functions), and [aggregate functions](/explore/table-calculations/functions/aggregate-functions) — they handle common patterns like accessing previous rows, row numbering, working across pivot columns, and computing totals.

For more advanced or custom SQL, we also have copy-paste SQL templates to help you get started with common table calculations. You can check out our table calculation SQL templates [here](/explore/table-calculations/sql-templates).
