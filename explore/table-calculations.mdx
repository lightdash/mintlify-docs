...
description: "Add calculations across your results table, like running totals and window aggregations"
doc-type: tutorial
---
...
<Frame>
![A results table where rows below 30% are highlighted in purple as the ones a table calculation filter hides, while the percentage total still reads 100%](/images/explore/table-calculations/table_calculation_filter_example.jpg)
</Frame>
