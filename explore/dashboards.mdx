---
title: "Dashboards"
description: "Arrange related charts, text, and video into one view your team can filter together"
---
...
This page covers building one: [planning](#plan-before-you-build), [creating the dashboard](#create-a-dashboard), [adding charts](#add-charts), [markdown and Loom tiles](#add-markdown-and-video-tiles), [saving](#save-your-dashboard), [owners](#assign-an-owner), [filters](#add-filters), [tabs](#add-tabs), [hiding tile headers](#hide-tile-headers), and [sharing](#share-your-dashboard). For what viewers can do once it's built, see [interacting with dashboards](/explore/dashboards/interact).
...
<Frame>
  <img
    alt="The Update Dashboard form with an Owner field set to a team member"
    className="block dark:hidden"
    src="/images/explore/dashboards/owner-assign-light.png"
  />
  <img
    alt="The Update Dashboard form with an Owner field set to a team member"
    className="hidden dark:block"
    src="/images/explore/dashboards/owner-assign-dark.png"
  />
</Frame>
...
<Frame>
  <img
    alt="The dashboard info popover listing the owner alongside last modified, views, and space"
    className="block dark:hidden"
    src="/images/explore/dashboards/owner-info-popover-light.png"
  />
  <img
    alt="The dashboard info popover listing the owner alongside last modified, views, and space"
    className="hidden dark:block"
    src="/images/explore/dashboards/owner-info-popover-dark.png"
  />
</Frame>
...
<Frame>
  <img
    alt="The All dashboards page filtered by owner, with the Owner column showing the same person on every row"
    className="block dark:hidden"
    src="/images/explore/dashboards/owner-filter-all-dashboards-light.png"
  />
  <img
    alt="The All dashboards page filtered by owner, with the Owner column showing the same person on every row"
    className="hidden dark:block"
    src="/images/explore/dashboards/owner-filter-all-dashboards-dark.png"
  />
</Frame>
...
<Frame>
  <img
    alt="The Delete user confirmation showing the number of dashboards the user owns and an option to transfer ownership to another user"
    className="block dark:hidden"
    src="/images/explore/dashboards/owner-transfer-on-delete-user-light.png"
  />
  <img
    alt="The Delete user confirmation showing the number of dashboards the user owns and an option to transfer ownership to another user"
    className="hidden dark:block"
    src="/images/explore/dashboards/owner-transfer-on-delete-user-dark.png"
  />
</Frame>

Ownership also travels with the dashboard: promoting it to another project keeps the owner, and [dashboards as code](/workflow/content-as-code#dashboards) carry it as an `ownerEmail` field.
