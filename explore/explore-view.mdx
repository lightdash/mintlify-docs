...
description: "Query a table, sort and chart the results, and save the chart"
---
...
Once the query runs, your data appears in the results table. Open the **Chart** section and choose a chart type — see [chart types and configurations](/visualizations).
...
A chart saved to a [space](/explore/spaces) can be shared on its own and reused across multiple dashboards. It's also the only way to [pin a single chart to your project homepage](/explore/homepage#pin-content).
