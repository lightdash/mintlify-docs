...
Each chart or dashboard can have one pending request at a time. While a request is pending you can cancel it yourself and resubmit later.
...
<Frame>
  <img src="/images/explore/review-requests/review-queue.png" alt="Review requests page listing pending and decided requests with their status and target space"/>
</Frame>
