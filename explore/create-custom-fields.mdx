...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-metric-creating.png"/>
</Frame>
...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-metric-added.png"/>
</Frame>

If you want to delete the custom metric, you can just click on the three-dot `options` menu and hit `Remove custom metric`

<Frame>
  <img src="/images/explore/create-custom-fields/custom-metric-deleting.png"/>
</Frame>
...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-metric-add-filter-while-creating.png"/>
</Frame>

2. You edit an existing custom metric:
<Frame>
  <img src="/images/explore/create-custom-fields/custom-metric-add-filter-while-edting.png"/>
</Frame>
...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-dimension-creating.png"/>
</Frame>
...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-dimension-bins.png"/>
</Frame>
...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-dimension-sql-add.png"/>
</Frame>
...
<Frame>
  <img src="/images/explore/create-custom-fields/custom-dimension-sql-form.png"/>
</Frame>

And after you run your query, you will see your new custom dimension categorising your orders' totals:
<Frame>
  <img src="/images/explore/create-custom-fields/custom-dimension-sql-result.png"/>
</Frame>
