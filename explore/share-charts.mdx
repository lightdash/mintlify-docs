...
Users with access to the containing space can find the chart under **Browse → All saved charts**, or you can send them its URL — a URL copied at any screen size opens the full chart for everyone. To share an individual saved chart without sharing its space, use [Direct access](/workspace-admin/direct-access). That guide also explains how sharing differs for dashboard-owned and reusable charts.
