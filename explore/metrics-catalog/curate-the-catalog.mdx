...
<Frame>
  ![The Metrics Catalog listing metrics with their descriptions, categories and popularity, and a search bar above](/images/explore/metrics-catalog/browsing-the-catalog-a9520c871903cedd96eb7923a1b3ae4e.webp)
</Frame>
...
<Frame>
  ![The Metrics Explorer with a metric plotted as a line over time, and controls for date range, granularity, dimension filter, segment-by and comparison](/images/explore/metrics-catalog/exploring-a-metric.png)
</Frame>
...
All through your Lightdash `.yml` files. Metrics curation is configured under the `spotlight` key — see [the `spotlight` config](/explore/metrics-catalog#the-spotlight-config) for an overview of what it covers.
...
<Frame>
  <iframe width="100%" height="420" src="https://www.loom.com/embed/1cedbf73be24445abecde95132284e91?sid=67cf36bd-f81e-40a8-b64e-972bbcfc836a" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen />
</Frame>
...
<Frame>
  <iframe width="100%" height="420" src="https://www.loom.com/embed/16690385fac04d97963d0dc36aba5f87?sid=7119a8aa-b4d2-4ba4-859c-0d76a6fe081b" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen />
</Frame>
...
`default_filter` uses the same syntax as [metric filters](/semantic-layer/metrics#available-filter-types), so you can express:
...
3. [Compile your project](/integrations/dbt/projects)
...
2. [Compile your project](/integrations/dbt/projects)
...
<Frame>
![A YAML file in VS Code with a red squiggle under an invalid key and a tooltip listing the allowed values](/images/explore/metrics-catalog/vscode-schema-validation-example.png)
</Frame>
...
| :---------------------------- | :-------------------------------------------: | :-------------------------------------------: | :-------------------------------------------: | :-------------------------------------------: | :-------------------------------------------: |
| Browse the 'Metrics catalog'  | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> |
| Add/edit /delete 'Categories' | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> |     <Icon icon="x" className="matrix-no" />    |     <Icon icon="x" className="matrix-no" />    |
| Open the 'Metrics Explorer'   | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> |     <Icon icon="x" className="matrix-no" />    |
