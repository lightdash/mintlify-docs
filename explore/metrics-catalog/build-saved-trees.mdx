---
title: "Saved Trees"
description: "Build shareable diagrams that show how your metrics relate to each other"
doc-type: tutorial
---
...
<Frame>
  <img
    ...
    src="/images/explore/metrics-catalog/canvas-saved-trees-dark.png"
    alt="Saved Trees on the canvas"
  />
  <img
    className="dark:hidden"
    src="/images/explore/metrics-catalog/canvas-saved-trees.png"
    alt="Saved Trees on the canvas"
  />
</Frame>
...
<Info>
  [Driver edges](/explore/metrics-catalog/drivers) are not stored with the tree — they are injected automatically whenever matching nodes are present.
</Info>
...
| :------------------ | :-------------------------------------------: | :-------------------------------------------: | :-------------------------------------------: | :-------------------------------------------: | :-------------------------------------------: |
| View a Saved Tree   | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> |
| Create a Saved Tree | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="x" className="matrix-no" />        | <Icon icon="x" className="matrix-no" />        |
| Edit a Saved Tree   | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="x" className="matrix-no" />        | <Icon icon="x" className="matrix-no" />        |
| Delete a Saved Tree | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="check" /> | <Icon icon="x" className="matrix-no" />        | <Icon icon="x" className="matrix-no" />        |
