...
<Info>
If you're a developer, you can add permanent filters to tables using the `sql_filter` yaml option. For more information see [Table configuration](/semantic-layer/tables#sql-filter)
</Info>
