...
- **Saved Trees** — Shareable diagrams of how your metrics relate to each other. Build them on a canvas by connecting metrics with edges, or let [drivers](/explore/metrics-catalog/drivers) defined in your `.yml` draw the relationships automatically.

<CardGroup cols={3}>
  <Card title="Catalog" icon="list" href="/explore/metrics-catalog/curate-the-catalog">
    Browse, explore, and curate your metrics in the Metrics Catalog.
  </Card>
  <Card title="Saved Trees" icon="sitemap" href="/explore/metrics-catalog/build-saved-trees">
    Map metric relationships and hierarchies in shareable tree diagrams.
  </Card>
  <Card title="Drivers" icon="arrow-trend-up" href="/explore/metrics-catalog/drivers">
