...
<Note>
  The [`RUNNING_TOTAL` window function](/explore/table-calculations/formulas#window) in a [formula table calculation](/explore/table-calculations/formulas) computes this without hand-written SQL — see the [running-total example](/explore/table-calculations/formulas#examples).
</Note>

[Just gimme the code! <Icon icon="bug"/>](#here’s-the-sql-you-can-copy-paste-to-calculate-a-running-total)

Here's an example of a running total:

<Frame>
  <img src="/images/explore/table-calculations/sql-templates/running-total/running-total-3d2fba5e8104a413e6d99545c75ee4d1.jpg" alt="A results table with a table calculation column accumulating a running total down the rows"/>
</Frame>
