...
description: Calculate the percent change between a value and the value in the row above it
doc-type: reference
---


<Note>
  The [`LAG` window function](/explore/table-calculations/formulas#window) in a [formula table calculation](/explore/table-calculations/formulas) computes this without hand-written SQL — see the [period-over-period growth example](/explore/table-calculations/formulas#examples).
</Note>

[Just gimme the code! <Icon icon="bug"/>](#here’s-the-sql-you-can-copy-paste-to-calculate-the-percent-change-from-the-previous)

Here's an example of a percent change calculation:

<Frame>
  <img src="/images/explore/table-calculations/sql-templates/percent-change-from-previous/percent-change-16ad7591cac52477dd6cd3b210ee4e66.jpg" alt="A results table with a table calculation column showing each row's percent change from the previous row"/>
</Frame>
