...
instead of raw SQL. When you create a new [table calculation](/explore/create-table-calculations),
**Formula** is the default input mode. You can switch to the SQL editor
any time.

<Frame>
  <img src="/images/explore/table-calculations/formulas/create-table-calculation-formula-light.png" alt="Creating a formula table calculation" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/formulas/create-table-calculation-formula-dark.png" alt="Creating a formula table calculation" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/explore/table-calculations/formulas/table-calculation-formula-in-table-light.png" alt="Formula table calculation in the results table" className="block dark:hidden" />
  <img src="/images/explore/table-calculations/formulas/table-calculation-formula-in-table-dark.png" alt="Formula table calculation in the results table" className="hidden dark:block" />
</Frame>
...
See [Contact Us](/help/support) for more options.
</Accordion>
...
- [Table calculations overview](/explore/create-table-calculations)
- [Table calculation functions](/explore/table-calculations/functions/row-functions)
- [SQL templates for table calculations](/explore/table-calculations/sql-templates)
