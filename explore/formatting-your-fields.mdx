...
description: "Hide, group, relabel, and number-format your fields in YAML, or format metrics and table calculations in the UI."
...
<Frame>
  <img src="/images/explore/formatting-your-fields/sub-group-label.png" />
</Frame>
...
<Frame>
  <img src="/images/explore/formatting-your-fields/description-on-hover.png" />
</Frame>
...
Check out [this doc](https://docs.lightdash.com/semantic-layer/metrics#metric-configuration) to see all of the other properties you can customize for metrics.
...
Check out [this doc](https://docs.lightdash.com/semantic-layer/dimensions#format) to see all the other compact values. to see all the other formatting options.
...
<Frame>
  <img src="/images/explore/formatting-your-fields/yaml-metric-formatting.png"/>
</Frame>

You can customize the formatting of your custom metrics when you create them, and later on from the results table.

<Frame>
  <img src="/images/explore/formatting-your-fields/custom-metric-format.png" />
</Frame>
...
<Frame>
  <img src="/images/explore/formatting-your-fields/table-calculation-create.png" />
</Frame>

Once you've created your table calculation, you can format it by clicking on the `Format` tab:

<Frame>
  <img src="/images/explore/formatting-your-fields/table-calculation-format.png" />
</Frame>
