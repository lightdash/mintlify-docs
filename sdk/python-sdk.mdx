...
Use standard Python comparison operators on dimensions to create filters:
...
For a detailed reference see the docs here: https://github.com/lightdash/python-sdk/tree/main/docs