...
Lightdash uses Ossie as an interchange format for the semantic layer: import Ossie models into a Lightdash project, export a Lightdash project as Ossie, and round-trip through `custom_extensions` for detail the base spec does not yet cover.
