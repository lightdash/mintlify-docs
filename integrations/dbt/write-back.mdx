...
To get started, create a [Custom Metric](/explore/create-custom-fields#custom-metrics) in the Explorer. Hover over the Custom Metric in the sidebar and click on the three-dot menu, then `Write back to dbt`.
...
To get started, create a [Custom Dimension](/explore/create-custom-fields#custom-dimensions) in the Explorer. Hover over the Custom Dimension in the sidebar and click on the three-dot menu, then `Write back to dbt`.
