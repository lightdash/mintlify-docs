...
<Info>
  <Badge icon="flask" color="purple" size="sm" shape="pill">Beta</Badge> Behavior and supported features may change as we iterate on MetricFlow support. [What Beta means](/support/feature-maturity-levels).
</Info>
