...
sidebarTitle: Slack
description: "Unfurl chart links, deliver scheduled reports and alerts, and chat with your AI agents in Slack"
---
...
<Frame>
![The Slack integration settings, with the notification channel, bot avatar, thread access consent, OAuth requirement, and multi-agent channel fields](/images/integrations/slack/slack-settings.png)
</Frame>
...
<Frame>
  ![A shared chart link unfurled in Slack, showing the chart title, description, a bar chart image, and an Open in Lightdash button](/images/integrations/slack/slack-chart-unfurl-45875cd3a4a3afc83b636571085be4c0.png)
</Frame>

And an unfurled dashboard:

<Frame>
  ![A shared dashboard link unfurled in Slack, showing the dashboard title, description, and a preview image of its tiles](/images/integrations/slack/slack-dashboard-unfurl-424589974afbb6574dff67199a9cdcda.png)
</Frame>
...
<Frame>
  ![A scheduled delivery in Slack with the chart name, description, and an image of the scatter plot, noting files expire after 3 days](/images/integrations/slack/slack-scheduled-chart-d2604af845afc166f4c13b2265a83b71.png)
</Frame>

And dashboards look like this when you choose _not_ to include an image:

<Frame>
  ![A scheduled dashboard delivery in Slack listing each chart with its own Download results button instead of an image](/images/integrations/slack/slack-scheduled-dashboard-a2e37864f7d080ea04d3cc28e367040e.png)
</Frame>
...
<Frame>
  ![A Slack alert naming the chart, the threshold that was crossed, and an image of the chart results](/images/integrations/slack/slack-alert-f80ad5e8c309f46972bb8e8a12238efc.png)
</Frame>
...
<Frame>
  ![The Slack message box with /invite @lightdash typed, and the Lightdash app shown as Not in channel above it](/images/integrations/slack/slack-invite-command.png)
</Frame>

- **Use channel settings** — click the channel name, go to **Integrations → Add an app**, then search for and add Lightdash.

<Frame>
  ![A private Slack channel's Integrations tab, with the Add an App button under the Apps section](/images/integrations/slack/slack-add-app-settings.png)
</Frame>
...
<Frame>
  ![A Slack channel details modal, with the Channel ID at the bottom and its copy button highlighted](/images/integrations/slack/slack-channel-id.png)
</Frame>

Paste the channel ID into the Channels input field and select **Look up channel ID** to find your private channel.

<Frame>
  ![The Lightdash Channels field with a channel ID pasted in and a Look up channel ID suggestion below it](/images/integrations/slack/slack-lookup-id.png)
</Frame>
