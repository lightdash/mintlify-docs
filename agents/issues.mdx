...
<Info>
  **Availability:** Issues is a [Beta](/support/feature-maturity-levels) feature available on **Enterprise** and **Cloud Pro** plans. It is **off by default** and must be enabled by an organization admin.
</Info>
