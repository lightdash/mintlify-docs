...
<Info>
  **Availability:** Deep research is a [Beta](/help/feature-maturity-levels) feature available on **Enterprise** plans. It is behind a feature flag. [Contact Lightdash](mailto:support@lightdash.com) to enable it for your organization.
</Info>
...
- **MCP servers** — only the [agent-attached servers](/agents/connect-external-mcp-servers) selected in the research settings.
