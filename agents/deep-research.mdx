...
description: "Run a multi-step AI investigation and get an evidence-backed report with verified charts and sources"
doc-type: reference
tag: "Beta"
---
...
<Steps>
  ...
  <Step title="Enable Deep research">
    Click the **+** button in the message input and select **Deep research**, in a new or an existing conversation. A check mark shows the mode is on. For longer investigative questions, the **+** button can pulse once to suggest this mode; you can still continue in regular chat.
  </Step>
...
Select **Open full report** from a completed or partially completed run card. Reports include a contents rail on larger screens so you can jump between findings. A report contains:
