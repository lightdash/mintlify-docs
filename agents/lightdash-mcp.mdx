...
To get the most value from MCP, ensure your Lightdash data is well-organized and documented. See our [AI agents best practices guide](/agents#best-practices) for detailed recommendations on:
