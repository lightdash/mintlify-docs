...
Yes. Memory and [project context](/agents/issues#the-lightdashproject_contextyml-file) are independent features. Memory does not require a connected GitHub or GitLab repository or any project context configuration to work.
