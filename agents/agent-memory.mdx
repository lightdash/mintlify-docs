...
| **Generated by** | Learned automatically from your questions, corrections, and feedback.                                   | Proposed by the [Reviews](/agents/reviews) agent from likely-wrong answers across the project.                                                                            |
...
Yes. Memory and [project context](/agents/reviews#the-lightdashproject_contextyml-file) are independent features. Memory does not require a connected GitHub or GitLab repository or any project context configuration to work.
