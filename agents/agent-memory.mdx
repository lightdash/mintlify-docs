...
Cross-user knowledge is handled separately by [project context](/agents/reviews) and knowledge documents — memory is the personal layer.
...
Memory and [project context](/agents/reviews) both improve future agent answers based on what happens in chat, but they solve different problems and apply in different ways.
...
| **Generated by** | Distilled automatically from your questions, corrections, and feedback.                                 | Proposed by the [Reviews](/agents/reviews) agent from likely-wrong answers across the project.                                                                            |
