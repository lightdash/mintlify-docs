...
Allow your agent to edit your dbt project from chat — renaming metrics, adding dimensions, or updating descriptions — and open a pull request with the changes for review. Read more on the [AI writeback (beta)](/agents/ai-writeback) feature.
