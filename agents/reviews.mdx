...
<Info>
  **Availability:** Reviews is a [Beta](/help/feature-maturity-levels) feature available on **Enterprise** and **Cloud Pro** plans. It is **off by default** and must be enabled by an organization admin.
</Info>
