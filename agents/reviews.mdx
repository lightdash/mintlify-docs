...
<Info>
  **Availability:** Reviews is a [Beta](/support/feature-maturity-levels) feature available on **Enterprise** and **Cloud Pro** plans. It is **off by default** and must be enabled by an organization admin.
</Info>
...
If you're still setting your first agent up, start with [agent setup](/agents/set-up-agents) and [evaluations](/agents/create-evaluation-suites) first — Reviews works best once there's real usage to learn from.
...
- [Agent visibility](/agents/visibility) — where Reviews fits into admin visibility overall.
