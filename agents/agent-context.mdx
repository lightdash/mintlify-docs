...
description: "Give every agent in a project shared background knowledge — terminology, table choices, business rules — through the lightdash.project_context.yml file."
doc-type: reference
---
