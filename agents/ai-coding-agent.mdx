...
- On self-hosted instances you need to bring your own E2B and Anthropic API keys, the same way you do for AI writeback. See [AI writeback](/self-host/enterprise-features/ai-writeback) — the coding agent uses a separate, leaner sandbox image but the same key setup.
...
- [AI writeback](/self-host/enterprise-features/ai-writeback) — E2B and Anthropic key setup that also applies to the coding agent.
