...
The SQL mode toggle is visible only to users who hold the **`manage:SqlRunner`** ability — the same permission required to use the [SQL Runner](/explore/sql-runner) page. If you don't see the toggle, ask a workspace admin to grant SQL Runner access to your role.
