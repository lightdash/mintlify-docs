...
When you pin a saved chart, the agent can read its actual data (subject to your [data access setting](/agents/data-access)). It honors the chart's saved filters, sorts, and custom metrics, so you can ask:
