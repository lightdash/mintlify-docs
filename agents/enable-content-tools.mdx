...
<Info>
  **Availability:** Content editing is a [Beta](/support/feature-maturity-levels) feature. Enable it for a specific agent when you are ready for that agent to create and update saved Lightdash content.
</Info>
