...
| Conversation retention | `ai-thread-retention` feature flag | Automatically delete AI agent conversations after a period of inactivity | [Conversation retention](/agents/conversation-retention) |
