...
| `MANAGED_AGENT_RUNTIME` | Transitional releases only: `ai-sdk` selects the AI SDK runner; `anthropic-managed` selects the hosted runner. Removed with the hosted runtime; ignored on AI SDK-only releases. |
