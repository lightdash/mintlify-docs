...
These variables allow you to customize the default appearance settings for your Lightdash instance's organizations. This color palette will be set for any new organizations you create.&#x20;

| Variable                       | Description                                                                               | Required? | Default |
| :----------------------------- | :---------------------------------------------------------------------------------------- | :-------: | :-----: |
| `DEFAULT_COLOR_PALETTE_NAME`   | Name of the default color palette                                                         |           |         |
| `DEFAULT_COLOR_PALETTE_COLORS` | Comma-separated list of hex color codes for the default color palette (must be 20 colors) |           |         |