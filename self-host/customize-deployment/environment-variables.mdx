...
| `SLACK_MULTI_AGENT_CHANNEL_ENABLED` | Enables [multi-agent Slack channels](/self-host/enterprise-features/multi-agent-slack) for the whole instance (default=false) |
