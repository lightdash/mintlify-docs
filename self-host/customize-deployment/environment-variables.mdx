...
| `INTERNAL_LIGHTDASH_HOST`                    | Internal Lightdash host for the Headless browser to send requests when your Lightdash instance is not accessible from the Internet.                                                                           |           | Same as SITE\_URL                                               |
...
## SMTP environment variables[​](#smtp-environment-variables "Direct link to SMTP environment variables")
...
## SSO environment variables[​](#sso-environment-variables "Direct link to SSO environment variables")
...
## Logging environment variables[​](#logging-environment-variables "Direct link to Logging environment variables")
...
## Prometheus environment variables[​](#prometheus-environment-variables "Direct link to Prometheus environment variables")
...
[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/self-host/customize-deployment/environment-variables.mdx)
