...
| Variable                          | Description                                                                                                                                          |
| :-------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------- |
| `LIGHTDASH_ENABLE_FEATURE_FLAGS`  | Comma-separated list of feature-flag IDs to force-enable for everyone in your instance. Example: `embedding,scim-token-management` |
