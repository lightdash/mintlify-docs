...
## Configure cloud storage on Google Cloud Platform[](#configure-cloud-storage-on-google-cloud-platform "Direct link to Configure cloud storage on Google Cloud Platform")
...
## Configure cloud storage on AWS[](#configure-cloud-storage-on-aws "Direct link to Configure cloud storage on AWS")
...
## Configure Lightdash to use S3 credentials[](#configure-lightdash-to-use-s3-credentials "Direct link to Configure Lightdash to use S3 credentials")
