...
| `AUTH_OIDC_METADATA_DOCUMENT_URL` | [URL to OIDC metadata discovery endpoint](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderConfigurationRequest) | ✅         |                       |
...
[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/self-host/customize-deployment/use-sso-login-for-self-hosted-lightdash.mdx)
