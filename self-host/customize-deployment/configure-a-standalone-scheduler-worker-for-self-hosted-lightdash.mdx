---
title: "Configure a standalone scheduler worker for self-hosted Lightdash"
...
### 1\. Disable scheduler worker in the main server[](#1-disable-scheduler-worker-in-the-main-server "Direct link to 1. Disable scheduler worker in the main server")
...
### 2\. Run standalone schedule worker[](#2-run-standalone-schedule-worker "Direct link to 2. Run standalone schedule worker")
...
### Example docker-compose.yml[](#example-docker-composeyml "Direct link to Example docker-compose.yml")
