...
Once the license validates, the backend also fetches the [organization roadmap](/self-host/customize-deployment/organization-roadmap) from `https://roadmap.lightdash.com` — allow-list that domain too.
</Note>
