...
## When to use Lightdash Cloud[](#when-to-use-lightdash-cloud "Direct link to When to use Lightdash Cloud")
...
## When to self-host[](#when-to-self-host "Direct link to When to self-host")
