...
Version numbers tell you how big a release is; the [release-safety signal](/self-host/upgrade-safety) tells you, per release and machine-readably, whether it's safe to roll and which versions you must pass through.
