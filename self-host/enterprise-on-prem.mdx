...
Once your license key is active, each Enterprise feature has its own setup page in the [enterprise features](/self-host/enterprise-features/ai-agents) group — AI agents, data apps, embedding, MCP, custom roles, service accounts, SCIM, pre-aggregates, AI writeback, and multi-agent Slack channels.
