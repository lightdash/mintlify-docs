...
<Note>
🛠 This page is for engineering teams self-hosting their own Lightdash instance. If you want to learn about Lightdash Enterprise features, go to the [Enterprise License Keys](/self-host/customize-deployment/enterprise-license-keys) guide.
</Note>
