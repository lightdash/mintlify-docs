...
Once SSO is in place, [SCIM](/workspace-admin/sso/scim) can provision users and [groups](/workspace-admin/manage-groups) from your identity provider automatically.
