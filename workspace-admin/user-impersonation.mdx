...
<Warning>
  If the project requires users to provide their own warehouse credentials, queries run with the impersonated user's [personal warehouse credentials](/personal-settings/personal-warehouse-connections) (including SSO-backed credentials).
</Warning>
