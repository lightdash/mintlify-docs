...
<Info>
  **Verified domains are available on Lightdash Cloud Pro and Enterprise plans.**

  They are part of per-organization SSO settings. Contact the Lightdash team if you don't see the **Verified domains** panel in your settings.
</Info>
