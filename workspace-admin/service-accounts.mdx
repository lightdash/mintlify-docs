...
For the full permission matrix, see [organization roles](/workspace-admin/roles#organization-roles).
...
1. Pick a project
2. Pick a role for that project — either one of the [project roles](/workspace-admin/roles#project-roles) (Viewer, Interactive Viewer, Editor, Developer, Admin) or a [custom role](/workspace-admin/custom-roles) defined in the organization
