...
<Frame>
  ![](../images/workspace-admin/scim-integration/scim-lightdash-user-settings-9f554881763a721af6463096fe8e1d59.png)
</Frame>

2. In the sidebar, select **SCIM Access Tokens**.

<Frame>
  ![](../images/workspace-admin/scim-integration/scim-lightdash-tokens-list-b060b94f0b68fc67274186809043c175.png)
</Frame>
...
<Frame>
  ![](../images/workspace-admin/scim-integration/scim-lightdash-generate-token-fd03c005c465260741db9f144782d7e4.png)
</Frame>

4. Once generated, copy and save it in a safe place, as it cannot be viewed again once the modal is closed.

<Frame>
  ![](../images/workspace-admin/scim-integration/scim-lightdash-generated-token-851f5ec6141dbd3dcb35910687f579fa.png)
</Frame>
...
<Frame>
  ![](../images/workspace-admin/scim-integration/scim-lightdash-view-url-3cfc6eb4588ba52111f287b6a5f08603.png)
</Frame>
...
<AccordionGroup>
  <Accordion title="Okta">
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-create-integration-b666384a8b1a307b610ccdef67667dcd.png)
    </Frame>
    5. Give it a friendly name and click **Next**.

    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-name-app-0c844947069855ee82176c7893a4291c.png)
    </Frame>
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-provisioning-3bacb4dce7b8a7229d5a93d71b89f016.png)
    </Frame>
    3. Select **Configure API Integration**.

    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-configure-api-integration-78a059f5ef6167aa33206c2c8ec2b2d0.png)
    </Frame>
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-assign-users-4cbb63bebcfc37077bbbdca39552e001.png)
    </Frame>
    <Info>
    ...
    **For Organization Role:**
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-org-role-attribute.png)
    </Frame>
    ...
    **For Project Roles:**
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-project-role-attribute.png)
    </Frame>
    ...
    **For Project Role Mapping:**
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-okta-role-mapping.png)
    </Frame>
  </Accordion>
  <Accordion title="Azure">
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-azure-create-app-3bb17d51662b8667f958aefbd2fea4ef.png)
    </Frame>
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-azure-edit-app-2b718ab6803faea2bae1f5ed40877256.png)
    </Frame>
    ...
    <Frame>
      ![](../images/workspace-admin/scim-integration/scim-azure-configure-provisioning-0913ad7db2b504ecbee342922e84da98.png)
    </Frame>
...
Lightdash defines two role scopes: Organization and Project. Organization roles can be set to member, viewer, interactive viewer, editor, developer, or admin. Project roles can be viewer, interactive viewer, editor, developer, admin, or a [custom role](/workspace-admin/custom-roles).
