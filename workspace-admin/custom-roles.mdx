...
<Info>
  <Badge icon="building-plus" color="blue" size="sm" shape="pill">Enterprise</Badge> Self-hosted instances also need `CUSTOM_ROLES_ENABLED=true`, see [enterprise features](/self-host/enterprise-features#custom-roles). [What each availability level means](/support/feature-availability). [View pricing](https://www.lightdash.com/pricing).
</Info>
