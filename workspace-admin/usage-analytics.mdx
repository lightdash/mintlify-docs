...
Or you can also use our [search bar](/get-started/explore-your-data/explore-your-content#using-the-search-bar) to get direct access to the different analytics dashboards by typing the name of the dashboard (eg: User activity)
