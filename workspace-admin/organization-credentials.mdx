...
<Info>
  **Organization credentials are only available on Lightdash Enterprise plans, and only for Snowflake SSO connections.** Support for additional warehouse types is planned.
