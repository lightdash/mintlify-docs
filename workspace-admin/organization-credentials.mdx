...
5. Enter the credential details:
   ...
   ![Screenshot from 2025-10-20 11-45-44.png](/images/references/organization-credentials/Screenshotfrom2025-10-2011-45-44.png)
...
![Screenshot from 2025-10-20 12-00-05.png](/images/references/organization-credentials/Screenshotfrom2025-10-2012-00-05.png)
...
Organization credentials work seamlessly with [preview projects](/guides/developer/preview-projects). When you create a preview project from a parent project that uses organization credentials, the preview will automatically inherit those credentials.
...
For more information about personal warehouse connections, see the [Personal warehouse connections documentation](/references/workspace/personal-warehouse-connections).

## Related features

- [Creating multiple projects](/references/workspace/how-to-create-multiple-projects): Learn more about project creation in Lightdash
- [Preview projects](/guides/developer/preview-projects): Understand how preview projects work with organization credentials
- [Roles and permissions](/references/workspace/roles): Learn about organization admin permissions
- [Personal warehouse connections](/references/workspace/personal-warehouse-connections): Understand individual user warehouse credentials