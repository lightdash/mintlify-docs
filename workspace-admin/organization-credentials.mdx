...
description: "Share reusable warehouse credentials so users can create projects securely"
doc-type: reference
---

<Info>
  <Badge icon="building-plus" color="blue" size="sm" shape="pill">Enterprise</Badge> Available for Snowflake SSO connections only; support for additional warehouse types is planned. [What each availability level means](/support/feature-availability). [View pricing](https://www.lightdash.com/pricing).
</Info>
...
2. Under **Organization settings**, open **Credentials**.

   <Frame>
   <img
     src="/images/workspace-admin/organization-credentials/Screenshotfrom2025-10-2012-05-34.png"
...
4. Enter the credential details:
   ...
   <Frame>
   ![Screenshot from 2025-10-20 11-45-44.png](/images/workspace-admin/organization-credentials/Screenshotfrom2025-10-2011-45-44.png)
   </Frame>
...
3. In the **Warehouse connection** section, select **Use organization credential** and choose the credential you created. This option only appears if your organization has credentials configured.

   <Frame>
   ![Screenshot from 2025-10-20 12-00-05.png](/images/workspace-admin/organization-credentials/Screenshotfrom2025-10-2012-00-05.png)
   </Frame>
...
Organization credentials work seamlessly with [preview projects](/workflow/preview-projects). When you create a preview project from a parent project that uses organization credentials, the preview will automatically inherit those credentials.
...
For more information about personal warehouse connections, see the [Personal warehouse connections documentation](/personal-settings/personal-warehouse-connections).

## Related features

- [Creating multiple projects](/workspace-admin/manage-projects): Learn more about project creation in Lightdash
- [Preview projects](/workflow/preview-projects): Understand how preview projects work with organization credentials
- [Roles and permissions](/workspace-admin/roles): Learn about organization admin permissions
- [Personal warehouse connections](/personal-settings/personal-warehouse-connections): Understand individual user warehouse credentials