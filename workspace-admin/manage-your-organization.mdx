...
<Frame>
![Leave organization flow: open the user menu, go to User settings, select the Profile tab, then click Leave in the Danger zone card.](/images/workspace-admin/manage-your-organization/leave-organization-flow.png)
</Frame>
