...
Only users with admin or project admin permissions can access compilation logs. See [roles and permissions](/workspace-admin/roles) for more information about access levels.
