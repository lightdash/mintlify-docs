...
<Info>
  **Groups are only available on Lightdash Enterprise.** For more information on our plans, visit our [pricing page](https://www.lightdash.com/pricing).

  Self-hosted deployments must also set the `GROUPS_ENABLED` [environment variable](/self-host/customize-deployment/environment-variables) to `true`. Without it, the Groups option won't appear in the sidebar, even for an organization admin.
</Info>
...
<Frame>
  ![The Users & groups tab in organization settings, listing each group with its member count and an edit button](/images/workspace-admin/manage-groups/groups-management-page-8871b97449641ed560fbd5dd34637802.jpg)
</Frame>
