...
description: "Send Lightdash report emails from your own domain instead of a Lightdash address"
doc-type: tutorial
---
...
- [Verified domains](/workspace-admin/sso/verified-domains) (separate
