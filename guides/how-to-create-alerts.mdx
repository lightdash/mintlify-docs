...
5. Select your Microsoft account and the Teams channel where you want to receive alerts
...
Once you have a webhook URL, add it to the list of destinations in the alerts form.
