...
Data apps can [declare their own npm dependencies](/guides/data-apps#declared-dependencies) alongside the sandbox template's built-in library set. The feature is gated by an instance-wide flag, off by default.
