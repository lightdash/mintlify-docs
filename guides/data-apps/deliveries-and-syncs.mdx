...
<Frame>
  <img src="/images/guides/data-apps/delivery-app-menu.png" alt="The data app header menu, with Schedule delivery and Google Sheets Sync entries" />
</Frame>
...
<Frame>
  <img src="/images/guides/data-apps/delivery-data-and-format.png" alt="The Data & format section of an app scheduled delivery, showing the csv, xlsx and Image formats, the detected query count, and the Results in Table and All Results limit options" />
</Frame>
...
<Frame>
  <img src="/images/guides/data-apps/data-apps-app-state.png" alt="The App state section of an app scheduled delivery, showing the Send current app state checkbox, the captured URL, and a State values table with one key pinned" />
</Frame>
...
<Frame>
  <img src="/images/guides/data-apps/delivery-gsheets-sync-modal.png" alt="The Sync with Google Sheets modal for a data app, listing an existing daily sync" />
</Frame>

Setup mirrors a chart Sync: name the sync, set a frequency and time zone, then pick the Google Sheet to write to.

<Frame>
  <img src="/images/guides/data-apps/data-apps-gsheet-sync-create.png" alt="The Sync with Google Sheets create form for a data app, with name, frequency, and Select Google Sheet controls" />
</Frame>
...
<Frame>
  <img src="/images/guides/data-apps/data-apps-gsheet-select-file.png" alt="Google's file picker listing the spreadsheets available to sync to" />
</Frame>
