...
Not sure which surface to point a user at? See [Choosing the right AI workflow in Lightdash](/guides/choosing-ai-workflow) for a decision tree, a comparison table, and guidance on when to use agents, MCP, YAML, or dashboards as code.
...
| Decide between agents, MCP, YAML, and dashboards as code | [Choosing the right AI workflow](/guides/choosing-ai-workflow) |
