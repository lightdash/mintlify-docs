...
- **[Pie chart](/references/chart-types/pie-chart)** — group labels and chart title
- **[Gauge](/references/chart-types/gauge)** — value label and chart title
- **[Funnel chart](/references/chart-types/funnel-chart)** — step labels and chart title
