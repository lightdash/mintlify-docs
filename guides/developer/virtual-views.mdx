---
title: "Virtual views"
description: "Virtual Views are created in the [SQL Runner](/references/sql-runner) and allow other users to reuse your custom SQL queries in Lightdash. They get listed in your `Tables` and can be used like the tables that come from your dbt project."
---
...
<Info>
  ...
  **A Virtual View won't be saved to or managed in your dbt project.**
  ...
  If you're expecting to use this query regularly, we recommend [writing it back to dbt](/references/dbt-write-back).
</Info>
