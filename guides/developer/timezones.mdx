...
<Frame>
  <img src="/images/guides/developer/timezones/dimension-tz-indicator-light.png" alt="Timezone indicator in the dimension list: hovering a date dimension shows 'Calendar date, not affected by the chart's timezone'" className="block dark:hidden" />
  <img src="/images/guides/developer/timezones/dimension-tz-indicator-dark.png" alt="Timezone indicator in the dimension list: hovering a date dimension shows 'Calendar date, not affected by the chart's timezone'" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/guides/developer/timezones/chart-timezone-picker-light.png" alt="The Run query settings dropdown in Explore, showing the Timezone picker alongside Auto-fetch results and Row limit" className="block dark:hidden" />
  <img src="/images/guides/developer/timezones/chart-timezone-picker-dark.png" alt="The Run query settings dropdown in Explore, showing the Timezone picker alongside Auto-fetch results and Row limit" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/guides/developer/timezones/project-timezone-filter-inputs-setting-light.png" alt="The Project time zone settings page with the Project time zone in filter inputs toggle" className="block dark:hidden" />
  <img src="/images/guides/developer/timezones/project-timezone-filter-inputs-setting-dark.png" alt="The Project time zone settings page with the Project time zone in filter inputs toggle" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/guides/developer/timezones/dst-fall-back-light.png" alt="Hourly bar chart for 3 November in America/New_York: every hour has one event except the 1 AM bar, which is doubled because the clocks fell back" className="block dark:hidden" />
  <img src="/images/guides/developer/timezones/dst-fall-back-dark.png" alt="Hourly bar chart for 3 November in America/New_York: every hour has one event except the 1 AM bar, which is doubled because the clocks fell back" className="hidden dark:block" />
</Frame>

On the spring-forward day (10 March), the clocks jump from 2 AM to 3 AM, so the 2 AM bar is missing entirely.

<Frame>
  <img src="/images/guides/developer/timezones/dst-spring-forward-light.png" alt="Hourly bar chart for 10 March in America/New_York: every hour has one event except 2 AM, which has no bar because that hour was skipped when the clocks sprang forward" className="block dark:hidden" />
  <img src="/images/guides/developer/timezones/dst-spring-forward-dark.png" alt="Hourly bar chart for 10 March in America/New_York: every hour has one event except 2 AM, which has no bar because that hour was skipped when the clocks sprang forward" className="hidden dark:block" />
</Frame>
