...
## Recommended workflow: ephemeral editing
...
Treating dashboards as code as ephemeral config files provides flexibility:
...
<Note>
This is the recommended practice for most organizations. However, if your team prefers a code-first approach where all changes flow through version control, that pattern works too. Choose what fits your team's goals and workflows.
</Note>
...
## AI-assisted chart development with Cursor

You can use AI coding assistants like Cursor to create and edit charts using natural language instead of clicking through the UI. This speeds up your analytics workflow by letting you describe what you want in plain English.
...
To set this up, connect Cursor to:
- The [Lightdash CLI](/references/lightdash-cli) for downloading and uploading content
- The [Lightdash MCP](/references/integrations/lightdash-mcp) for semantic layer access
- Your dbt project

Once connected, you can:
- Download dashboards and charts as YAML using `lightdash download`
- Prompt Cursor in natural language to create or modify charts
- Upload your changes back to Lightdash using `lightdash upload`
