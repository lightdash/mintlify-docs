...
### Here's the SQL you can copy-paste to calculate a running total[](#heres-the-sql-you-can-copy-paste-to-calculate-a-running-total "Direct link to Here's the SQL you can copy-paste to calculate a running total")
