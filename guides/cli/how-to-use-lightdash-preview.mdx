...
<AccordionGroup>
  <Accordion title="BigQuery">
    ...
    Create a service account which has read and write access to your BigQuery project. Add the service account credentials (the JSON file) that you want to use for your GitHub action. It should look something like this:
