...
<AccordionGroup>
   <Accordion title="1. You can login on the CLI on the browser using OAuth2.">
    ...
    This will open a new tab on your default browser using your Lightdash account, simply login on your browser if you haven't already, then authorize the `lightdash-cli` client and you will get authenticated in the CLI. 
