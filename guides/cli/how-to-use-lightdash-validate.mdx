...
![CLI validate](/assets/images/cli-validate-a18f39c4e5dc0eab842d963fe17188a0.png)

### Validate your changes against your project by running lightdash validate[​](#validate-your-changes-against-your-project-by-running-lightdash-validate "Direct link to Validate your changes against your project by running lightdash validate")
...
![](/assets/images/project-id-6ee39e064d8dd7026c295db3b8eaff68.png)
...
```
- name: Start preview  run: lightdash start-preview- name: Validate preview  run: lightdash validate --preview
```
...
[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/guides/cli/how-to-use-lightdash-validate.mdx)
