---
title: "Sync your changes with Lightdash deploy"
---
...
## `lightdash deploy` syncs the changes in your dbt project to Lightdash[​](#lightdash-deploy-syncs-the-changes-in-your-dbt-project-to-lightdash "Direct link to lightdash-deploy-syncs-the-changes-in-your-dbt-project-to-lightdash")
...
```
git checkout main # checkout main or master - or whatever your production branch name is where you've merged your changesgit pulllightdash deploy # --target prod. If you use developer profiles in your dbt project, you might need this flag. See below.
```
...
## Automatically deploy your changes to Lightdash using a GitHub action[​](#automatically-deploy-your-changes-to-lightdash-using-a-github-action "Direct link to Automatically deploy your changes to Lightdash using a GitHub action")
...
[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/guides/cli/how-to-use-lightdash-deploy.mdx)
