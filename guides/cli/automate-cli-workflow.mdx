...
<Steps>
  <Step title="Add the credentials to Github secrets">
  ...
  <Step title="Create workflows in Github">
...
<Steps>
  <Step title="Add the credentials to Github secrets">
  This step is the same as #1 in the previous section: [Add previews to pull requests](/guides/cli/automate-cli-workflow#add-previews-to-pull-requests). 
  </Step>
  <Step title="Create deploy.yml workflow in Github">
