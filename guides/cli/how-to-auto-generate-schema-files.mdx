...
### The Lightdash CLI will automatically add doc blocks to your .yml files[](#the-lightdash-cli-will-automatically-add-doc-blocks-to-your-yml-files "Direct link to The Lightdash CLI will automatically add doc blocks to your .yml files")
