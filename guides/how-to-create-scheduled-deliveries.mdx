...
You'll get a modal that pops up and shows you the list of existing scheduled deliveries for your saved chart or dashboard, and gives you the option to `create new`. By default, the modal only shows scheduled deliveries that you own. Admins and other roles with permission to manage all scheduled deliveries see every delivery on the resource; the full project-wide list is always available from the [scheduled deliveries overview](#overview-of-your-scheduled-deliveries) in project settings.
