...
<Warning>
  The legacy **Connectors** method for incoming webhooks in Microsoft Teams has been deprecated. You should now use **Workflows** (powered by Power Automate) to create webhook URLs.
</Warning>

### How to create a webhook in Teams using Workflows

The recommended way to set up an incoming webhook is through the Power Automate Workflows app:

1. Go to [Power Automate](https://make.powerautomate.com/)
2. Select **Templates**
3. Filter by **webhook**
4. Select the **"Send webhook alerts to a channel"** template
5. Select your Microsoft account and the Teams channel where you want to receive deliveries
6. Once the workflow is added, click **Edit** on the workflow
7. Select the **"When a Teams webhook request is received"** trigger step
8. Copy the **HTTP URL** — this is your webhook URL
9. Paste that URL into the webhook field in Lightdash

For more details, see the [official Microsoft documentation on creating incoming webhooks with Workflows](https://support.microsoft.com/en-us/office/create-incoming-webhooks-with-workflows-for-microsoft-teams-8ae491c7-0394-4861-ba59-055e33f75498).

Once you have a webhook URL, add it to the list of destinations in the scheduled deliveries form. You can also test how it looks on Microsoft Teams by pressing `send now`.

<Frame>
  ![](/images/guides/how-to-create-scheduled-deliveries/msteams-scheduler.png)
</Frame>

<Frame>
  ![](/images/guides/how-to-create-scheduled-deliveries/msteams-chart.png)
</Frame>
