...
You can now send your Lightdash scheduled deliveries and alerts directly to Microsoft Teams using incoming webhooks. This allows you to keep your team updated with key metrics and reports, right inside your Teams channels.
...
Once you have a webhook, add it to the the list of destinations in scheduled deliveries form. You can also test how it looks on Microsoft teams by pressing `send now`.

<Frame>
  <img src="/images/guides/msteams-scheduler.png" alt=""/>
</Frame>

<Frame>
  <img src="/images/guides/msteams-chart.png" alt=""/>
</Frame>
