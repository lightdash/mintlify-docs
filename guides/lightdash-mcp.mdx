...
<Accordion title="Setup instructions">
  1. **Access Settings in Claude.ai**
     ...
     <Frame>
       ![Navigate to profile menu in bottom-left corner and click Settings](/images/guides/mcp/claude-ai-01-click-profile-settings.png)
     </Frame>
  2. **Add Custom Connector**
     ...
     <Frame>
       ![Select Connectors from the sidebar menu, then click Add custom connector button](/images/guides/mcp/claude-ai-02-select-connectors-then-add-custom-connector.png)
     </Frame>
  3. **Configure Connection**
     ...
     <Frame>
       ![Enter Lightdash as the name and your instance MCP URL in the configuration form](/images/guides/mcp/claude-ai-03-fill-out-name-and-mcp-url.png)
     </Frame>
  ...
  4. **Connect and Authenticate**
     ...
     <Frame>
       ![Click the Connect button to start OAuth authentication with Lightdash](/images/guides/mcp/claude-ai-04-click-connect.png)
     </Frame>
  5. **Complete OAuth Flow**
     ...
     <Frame>
       ![Login to Lightdash with your credentials and approve the OAuth connection request](/images/guides/mcp/claude-ai-05-oauth-flow-via-lightdsah.png)
     </Frame>
  6. **Configure Permissions (Optional)**
     ...
     <Frame>
       ![Optional: Configure MCP tool access and permissions for your Claude assistant](/images/guides/mcp/claude-ai-06-OPTIONAL-configure.png)
     </Frame>
</Accordion>
...
<Accordion title="Setup instructions">
  1. **Use the /mcp command in Claude Code**
     ...
     <Frame>
       ![Type /mcp to see available MCP connections](/images/guides/mcp/claude-code-01-slash-mcp-command.png)
     </Frame>
  2. **Select Lightdash from the list**

     <Frame>
       ![Navigate to Lightdash using arrow keys](/images/guides/mcp/claude-code-02-select-lightdash-navigating-using-arrow-keys.png)
     </Frame>
  3. **Authenticate with Lightdash**

     <Frame>
       ![Select Authenticate and hit Enter](/images/guides/mcp/claude-code-03-select-authenticate-hit-enter.png)
     </Frame>
  4. **Complete OAuth Flow**

     <Frame>
       ![Complete the OAuth flow via Lightdash](/images/guides/mcp/claude-code-04-complete-oauth-flow-via-lightdash.png)
     </Frame>
  5. **Start using MCP**

     <Frame>
       ![Start prompting after successful authentication](/images/guides/mcp/claude-code-05-start-prompting-after-successful-auth.png)
     </Frame>
...
<Accordion title="Setting up custom instructions for Claude">
  <Frame>
    ![Setting up custom instructions for Lightdash MCP in Claude](/images/guides/mcp/setting-up-custom-instructions-01-claude.png)
  </Frame>
...
<AccordionGroup>
  <Accordion title="Verifying MCP connection">
    <Frame>
      ![Verifying MCP connection and listing available tools](/images/guides/mcp/examples-01-verifying-mcp-connection.png)
    </Frame>
  </Accordion>
  <Accordion title="Setting up project and finding dashboards">
    <Frame>
      ![Setting up project context and finding dashboards](/images/guides/mcp/examples-02-setting-up-project-and-finding-dashboards.png)
    </Frame>
  </Accordion>
  <Accordion title="Finding explores and fields, and executing metric queries">
    <Frame>
      ![Finding explores and fields, then executing metric queries to analyze data](/images/guides/mcp/examples-03-finding-explores-and-fields-and-executing-metric-query-to-analyze-data.png)
    </Frame>
  </Accordion>
</AccordionGroup>
