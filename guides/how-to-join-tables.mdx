...
```
version: 2models:  - name: users    meta:      joins:        - join: segment_web_sessions          sql_on: ${segment_web_sessions.user_id} = ${users.user_id}    columns:
```
...
![screenshot-joined-tables](/assets/images/screenshot-joined-tables-b819fbf3ae2d43361d84870d38eb86fc.png)

## Next steps[​](#next-steps "Direct link to Next steps")

* Read more about customising joins in the [joins reference](/references/joins)

[Edit this page](https://github.com/lightdash/lightdash/edit/main/docs/docs/guides/how-to-join-tables.md)
