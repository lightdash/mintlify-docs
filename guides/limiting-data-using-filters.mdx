...
<Info>
If you want to restrict access to temporary filters, you can disable the `Add filters` button on a dashboard. Head to edit mode and click the 'x' on the `Add filters` dropdown to remove it. End users will then be restricted to only using filters that have been specifically set up in dashboard edit mode.
</Info>
