...
- Users with `Can view` access to the space can open the app and interact with it.
- Users with `Can edit` or `Full access` to the space can iterate on it, rename it, move it, and delete it.
