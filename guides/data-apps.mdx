...
See [Scheduled deliveries and syncs](/guides/data-apps/deliveries-and-syncs) for details.
...
See [Building data apps locally](/guides/data-apps/building-locally) for the full workflow.
