...
The same runtime also powers reusable custom chart types. You describe the chart you want, Lightdash builds it, and anyone in the project can then pick it as a chart type in the Explorer, map their query's fields to it, and save the result like any other chart.

Chart types are built in their own gallery and builder, separate from data apps. See [Custom charts](/references/chart-types/custom-charts) for details.
