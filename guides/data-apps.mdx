...
The query inspector is available to anyone who can view the app - both in the builder and in the app preview. To open it, click the **⋯** menu in the header and select **View queries**. Close it with the **X** in the panel; reopen it from the same menu. In the builder, a **Persist logs** toggle keeps query history across rebuilds; in the preview the iframe doesn't reload mid-session, so the toggle is hidden.
