...
Data apps are not yet duplicated into [developer preview projects](/get-started/develop-in-lightdash/adding-tables-to-lightdash) or remapped during content promotion between projects. Dashboard tiles that embed a data app are still copied, but the tile keeps pointing at the original app rather than getting its own copy.
