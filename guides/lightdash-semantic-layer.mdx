...
[**Metrics**](/get-started/develop-in-lightdash/how-to-create-metrics)
...
[**Dimensions**](/get-started/develop-in-lightdash/how-to-create-dimensions)
...
[**Tables**](/get-started/develop-in-lightdash/adding-tables-to-lightdash)
...
AI agents can propose changes back to your semantic layer, like new metrics, dimensions, or refinements to existing definitions. See [AI writeback (beta)](/guides/ai-agents/ai-writeback#ai-writeback-beta) for details.
