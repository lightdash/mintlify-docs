...
For programmatic access, [Lightdash has an API](/api-reference/v1/introduction) where you can get metrics, dimensions, and their definitions, as well as run queries against the semantic layer. You can also interact with other Lightdash artefacts like projects, users, and dashboards.
