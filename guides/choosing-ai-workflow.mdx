...
- **Did the agent get something wrong?**
  Improve descriptions, AI hints, project context, [verified answers](/guides/ai-agents/verified-answers), [evaluations](/guides/ai-agents/evaluations), or [Issues](/guides/ai-agents/issues) findings. *(Issues is Beta.)*
...
| Issues and evaluations | Improving agent accuracy over time | Agent owner, data lead | Verified answers, eval scores, issue findings | Verified answers, evals suite, Issues *(Beta)* | [Verified answers](/guides/ai-agents/verified-answers), [Evaluations](/guides/ai-agents/evaluations), [Issues](/guides/ai-agents/issues), [Best practices](/guides/ai-agents/best-practices) |
...
- Use **thumbs up / thumbs down** and **[Issues](/guides/ai-agents/issues)** *(Beta)* findings to prioritize fixes.
...
- **Keep writeback and self-improvement controlled.** AI writeback, content editing, and Issues are Beta — use previews, PR review, and validation before anything reaches production.
...
- [Issues](/guides/ai-agents/issues) *(Beta)*
