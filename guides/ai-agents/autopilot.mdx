...
Autopilot's activity log sits alongside thread and MCP activity as part of your admin visibility into agents — see [Monitoring your agents](/guides/ai-agents/monitoring-your-agents).
