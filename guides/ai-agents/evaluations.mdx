...
1. **Define evaluation questions** - Build a set of test questions for each agent. You can either:
   ...
   - Select responses from existing agent conversations in the [Threads tab](/guides/ai-agents/monitoring-your-agents#thread-activity) to add to your evaluation set
