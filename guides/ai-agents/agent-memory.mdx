...
<Frame>
  <img src="../../images/guides/ai-agents/agent-memory/promote-memory-to-project-context.png" alt="The my memories panel showing a selected memory with the Propose for project context button highlighted in the top right." />
</Frame>
