...
Create evaluation suites to systematically test your agent's performance and ensure consistent responses. Remember: your agent is only as clever as the context and instructions you've given it. For complex data models and diverse use cases, evaluations are essential for refining your agent.
...
-   **Admins: Review feedback regularly** - As an admin, set aside time to review thumbs-down responses, understand patterns, and give targeted feedback to your agent through conversations and instruction updates

-   **Build from real interactions** - Filter and add thumbs-down responses to your evaluation suite. This helps test fixes and prevent regressions on real-world issues your team actually encounters
