...
<Steps>
  <Step title="Create your first agent">
    Set up a new AI agent in your Lightdash project, [read below](#create-a-new-agent)
  </Step>
  <Step title="Configure your agent">
    Use tags to control which data the agent can access, [read the guide](#configure-your-agent).
  </Step>
  <Step title="Connect to Slack">
    Enable team collaboration through Slack, [read the guide](#slack-integration-(optional))
  </Step>
</Steps>
...
Allow your agent to propose changes to your semantic layer, including updating descriptions and creating new metrics. Changes are tracked in changesets for review. Read more on [self-improvement](/guides/ai-agents/self-improvement) feature.
...
1. First, add the desired slack channel to your agent integration settings.

<Frame>
  <img src="/images/guides/ai-agents/ai-integrations.png" alt="" />
</Frame>

2. Next, add the `Lightdash for analytics` app to your desired slack channel:
<Frame>
  <img src="/images/guides/ai-agents/add-lightdash-app-to-slack.png" alt="" />
</Frame>

3. You can interact with your AI agent in slack just as you would in the Lightdash UI - just tag your agent and ask it a question!
<Frame>
