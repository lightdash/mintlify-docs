...
#### How agent interactions work in a multi-agent channel
...
- **Reply in an existing thread** — `@mention` the Lightdash Slack app to get a response. Without the mention, Lightdash will not respond in-thread.
