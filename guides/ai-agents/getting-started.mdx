...
1. First, add the desired slack channel to your agent integration settings.Check out all the cool ways to integrate your agent into slack [here](/guides/using-slack-integration#using-the-slack-integration)
