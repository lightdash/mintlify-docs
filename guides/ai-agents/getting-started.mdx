...
Connect your agent to Slack channels so users can interact directly from Slack. First, add the desired slack channel to your agent integration settings.

<Frame>
  <img src="/images/guides/ai-agents/ai-integrations.png" alt="" />
</Frame>

Next, add the Lightdash for analytics app to your desired slack channel:
<Frame>
