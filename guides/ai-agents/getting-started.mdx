...
Allow your agent to propose changes to your semantic layer, including updating descriptions and creating new metrics. Changes are tracked in changesets for review. Read more on self-improvement [here](/guides/ai-agents/self-improvement)
