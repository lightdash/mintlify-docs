...
Every tool call made through a connected MCP server — who called it, with what arguments, success or failure, and the calling client's identity — is logged for admins. See [Monitoring your agents](/guides/ai-agents/monitoring-your-agents#mcp-activity) to review it.

## Related

- [Getting started with AI agents](/guides/ai-agents/getting-started)
- [Data access control](/guides/ai-agents/data-access)
- [Monitoring your agents](/guides/ai-agents/monitoring-your-agents) — admin visibility into MCP tool calls
