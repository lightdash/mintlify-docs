...
You can also expand a connected MCP server to review the tools it exposes and how many are currently enabled for use.

<Frame>
  <img
    src="/images/guides/ai-agents/mcp-server-tool-list.png"
