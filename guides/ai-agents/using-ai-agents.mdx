...
- **Open pull requests against your dbt repository** - Ask the agent to rename a metric, add a dimension, or edit a YAML file and it can open a pull request for review. See [Repository writeback](/guides/ai-agents/repository-writeback).
