...
<CardGroup cols={2}>
  ...
  <Card title="Issues (Beta)" icon="clipboard-list-check" horizontal href="/guides/ai-agents/issues">
...
- **[Issues (Beta)](/guides/ai-agents/issues)** - A shared board for data problems: Lightdash scans agent turns for likely-wrong answers and users can file issues from charts, dashboards, and tiles — with one-click fixes to your semantic layer or [project context](/guides/ai-agents/issues#the-lightdashproject_contextyml-file)
