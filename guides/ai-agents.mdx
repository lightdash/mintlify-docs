...
<CardGroup cols={2}>
  ...
  <Card title="MCP servers" icon="hexagon-nodes" horizontal href="/guides/ai-agents/mcp-servers">
...
- **Extensible with MCP** - Connect agents to external Model Context Protocol servers to add custom tools and data sources
