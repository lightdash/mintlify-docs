...
<CardGroup cols={2}>
  ...
  <Card title="Self-improvement" icon="sparkles" horizontal href="/guides/ai-agents/self-improvement">
...
- **Evaluations (Beta) **- Create test suites to validate your agent’s answers and prevent regressions.