...
3. **Configure your agent:**
   ...
   - **Self-Improvement (optional, Beta)** - Allow your agent to propose changes to your semantic layer, including updating descriptions and creating new metrics. Changes are tracked in changesets for review
...
1. Edit your agent
2. Navigate to the "Knowledge & Expertise" section
3. Toggle the "Self-improvement" option
4. Save your changes
...
<Info>Only admins can enable self-improvement and trigger improvements</Info>
