...
<CardGroup cols={2}>
  ...
  <Card title="Deep research (Beta)" icon="telescope" horizontal href="/guides/ai-agents/deep-research">
  ...
  <Card title="Reviews (Beta)" icon="clipboard-list-check" horizontal href="/guides/ai-agents/reviews">
...
- **[Deep research (Beta)](/guides/ai-agents/deep-research)** - Run durable, multi-step investigations that produce evidence-backed reports with confidence levels and chart snapshots
