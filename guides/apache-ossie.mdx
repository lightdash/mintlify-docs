...
icon: "handshake"
description: "Lightdash will support Apache Ossie (Incubating), formerly the Open Semantic Interchange (OSI) — the open specification for semantic layer and ontology interchange."
---
