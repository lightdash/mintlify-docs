---
title: "Adding and managing Tables in your Lightdash project"
---
...
## Adding Tables to your Lightdash project using the CLI[](#adding-tables-to-your-lightdash-project-using-the-cli "Direct link to Adding Tables to your Lightdash project using the CLI")

### Step 1. Install the Lightdash CLI tool (if you haven't already)[](#step-1-install-the-lightdash-cli-tool-if-you-havent-already "Direct link to Step 1. Install the Lightdash CLI tool (if you haven't already)")
...
### Step 2. Add Tables to Lightdash using `lightdash dbt run -s my_model`[](#step-2-add-tables-to-lightdash-using-lightdash-dbt-run--s-my%5Fmodel "Direct link to step-2-add-tables-to-lightdash-using-lightdash-dbt-run--s-my_model")
...
### Step 3. Preview your changes using `lightdash preview`[](#step-3-preview-your-changes-using-lightdash-preview "Direct link to step-3-preview-your-changes-using-lightdash-preview")
...
## Configuring which Tables appear in your Lightdash project[](#configuring-which-tables-appear-in-your-lightdash-project "Direct link to Configuring which Tables appear in your Lightdash project")
...
### Limiting the Tables in Lightdash using dbt tags[](#limiting-the-tables-in-lightdash-using-dbt-tags "Direct link to Limiting the Tables in Lightdash using dbt tags")
