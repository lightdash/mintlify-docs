...
First, generate an embed secret for your project. This secret is used to sign JWT tokens that authenticate embed requests.

<Frame>
  <img src="/images/guides/embed-create-secret-fbb86d6bcb70f4d004c48adb3c107922.png" alt="Create embed secret in Lightdash"/>
</Frame>
...
You can regenerate the secret anytime, but this will invalidate all existing embed URLs.
...
<Frame>
  <img src="/images/guides/embed-add-dashboard-cb6bef5fde69ba9d6eaeb693744d75cc.png" alt="Add allowed dashboards"/>
</Frame>
...
<Frame>
  <img src="/images/guides/embed-iframe-interactivity.png" alt="Configure iframe interactivity"/>
</Frame>
...
Filter data based on the viewing user's properties. See the [user attributes reference](/references/user-attributes) for complete details.
