...
## Do I need a Lightdash account to be able to view embedded content?[](#do-i-need-a-lightdash-account-to-be-able-to-view-embedded-content "Direct link to Do I need a Lightdash account to be able to view embedded content?")
...
### Create a user attribute in Lightdash[](#create-a-user-attribute-in-lightdash "Direct link to Create a user attribute in Lightdash")
