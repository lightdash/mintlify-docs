...
<Warning>
  **Admin access required:** This feature is restricted to admin users only because it updates content project-wide, including charts and dashboards that individual users should not have access to modify.
</Warning>
