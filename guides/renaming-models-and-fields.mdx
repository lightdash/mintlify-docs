...
![rename fix button](/images/guides/renaming-models-and-fields/rename_fix_button.png)

You can now choose to rename a field or model using the list of **existing** values.

<img
  src="/images/guides/renaming-models-and-fields/rename_modal.png"
  alt="rename modal"
  className="mx-auto"
  style={{ width:"50%" }}
/>
...
![rename CLI list](/images/guides/renaming-models-and-fields/rename_cli_list.png)
