...
After making changes to dbt, you will notice some charts will start failing. You can fix these directly on the validation page by renaming the broken charts. You can easily access to the validation page by clicking on the bell on the navigation bar.
...
Optionally, you can click **Fix all ocurrences** to rename the same field / table on all content, including other charts, dashboards and scheduled deliveries. 
