...
description: Push your local dbt project to your production Lightdash project with lightdash deploy, or refresh metadata from your connected git repository with lightdash refresh.
icon: "ship"
doc-type: tutorial
tag: "Tutorial"
---
