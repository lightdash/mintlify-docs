...
<Note>
  Newer Homebrew versions may block formulas from third-party taps unless you trust them first. If the install fails, run the `brew trust` line above and try again.
</Note>
