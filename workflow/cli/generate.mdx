---
title: "Generate semantic layer YAML"
sidebarTitle: "Generate YAML"
description: Auto-generate and sync schema.yml files so your dbt models appear as Tables in Lightdash
keywords:
  - lightdash generate
  - generate schema.yml
...
<Tip>
Not too sure what a .yml file or a Table is? Be sure to check out our tutorial on [Adding Tables to Lightdash](/semantic-layer/tables) for more details.
</Tip>
