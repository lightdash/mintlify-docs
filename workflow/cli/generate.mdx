...
<Tip>
Not too sure what a .yml file or a Table is? Be sure to check out our tutorial on [Adding Tables to Lightdash](/get-started/build-your-semantic-layer/add-tables-to-lightdash) for more details.
</Tip>
