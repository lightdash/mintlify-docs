...
|[`lightdash apps create`](/workflow/cli/reference#lightdash-apps-create)               | Scaffold a new [data app](/data-apps/apps-as-code) locally                          |
|[`lightdash apps preview`](/workflow/cli/reference#lightdash-apps-preview)             | Preview a downloaded [data app](/data-apps/apps-as-code) locally against real data   |
|[`lightdash apps validate`](/workflow/cli/reference#lightdash-apps-validate)           | Validate a [data app](/data-apps/apps-as-code) locally before uploading             |
...
Scaffold a new [data app](/data-apps/apps-as-code) folder locally. The app is created on the server on your first `lightdash upload`.
...
Validate one or more [data apps](/data-apps/apps-as-code) locally. Checks the app manifest (`lightdash-app.yml`), dependencies (`package.json` and `pnpm-lock.yaml`), source files under `src/`, external connection aliases, and semantic-layer references used in code.
