...
- `--apps-only`
  - (default: false)
  - download only data apps, skipping charts, dashboards, and space files (implies `--skip-charts --skip-dashboards --skip-spaces`). Requires `--apps <refs...>` or `--include-apps`. Recommended for app-focused checkouts.
