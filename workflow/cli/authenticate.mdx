...
description: "Log in with browser OAuth, a personal access token, or CI environment variables"
doc-type: tutorial
---
...
<Frame>
  <img src="/images/workflow/cli/authenticate/oauth-authorize.png" alt="Browser Authorize Application prompt showing the lightdash-cli client, read write scope, and Approve and Deny buttons" />
</Frame>
...
* [Automatically generating .yml for your dbt models using lightdash generate](/workflow/cli/generate)

* [Testing your changes with developer previews using lightdash preview](/workflow/preview-projects)

* [Deploying your changes to production using lightdash deploy](/workflow/cli/deploy)
