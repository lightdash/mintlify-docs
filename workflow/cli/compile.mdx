...
* If you want to have different connection settings depending on the user that opened the pull request (dev profiles), then [check out this guide](/workflow/preview-projects#how-to-use-the-developer-credentials-in-your-preview-project).
