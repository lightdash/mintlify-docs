...
description: Catch Lightdash errors on every pull request with a dbt compile GitHub Action
doc-type: tutorial
---
...
The compile action authenticates with Lightdash and your warehouse using GitHub secrets. Set them up once by following [Set up secrets and credentials](/workflow/set-up-ci-cd#set-up-secrets-and-credentials) — the same secrets work for every Lightdash CI workflow.
