...
For the full setup, including how to compile only a subset of your dbt models and how to enable strict compilation, see [Compile changes](/workflow/cli/compile).
