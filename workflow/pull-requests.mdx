...
| Source | Created by |
| --- | --- |
| **Custom metric** | Writing back a [Custom Metric](/semantic-layer/dbt/write-back#write-back-metrics-from-custom-metrics) to dbt |
| **Custom dimension** | Writing back a [Custom Dimension](/semantic-layer/dbt/write-back#write-back-dimensions-from-custom-dimensions) to dbt |
