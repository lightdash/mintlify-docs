...
* the command `lightdash deploy` is run on the [Lightdash CLI](/get-started/build-your-semantic-layer) (you can read more about automatically deploying your changes using GitHub actions [here](/workflow/cli/deploy#automatically-deploy-your-changes-to-lightdash-using-a-github-action))
