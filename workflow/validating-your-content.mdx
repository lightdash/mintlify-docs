...
The content validation page can be opened by [admins and developers](/references/workspace/roles) from the project settings. There you'll see any broken charts or dashboards in your project and information about what is causing the errors.

You can access the content validation dashboard by heading to project settings, then selecting the **Validator** tab. 

![validator page](/images/guides/developer/validator-page.jpg)
...
![validation errors in nav bar](/images/guides/developer/validation-errors.png)
...
* the command `lightdash deploy` is run on the [Lightdash CLI](/get-started/develop-in-lightdash/intro) (you can read more about automatically deploying your changes using GitHub actions [here](/guides/cli/how-to-use-lightdash-deploy#automatically-deploy-your-changes-to-lightdash-using-a-github-action))
...
**Chart and dashboard errors** can be resolved by opening the content in Lightdash and updating the field references, but this usually means you have to rebuild your chart(s). The preferred method to resolve errors is to [rename fields in the app](/guides/developer/renaming-models-and-fields#rename-in-lightdash) or use `lightdash rename` [in the CLI](/guides/developer/renaming-models-and-fields#rename-in-the-cli). You can also find and replace references in charts and dasboards using [dashboards as code](/guides/developer/dashboards-as-code).
