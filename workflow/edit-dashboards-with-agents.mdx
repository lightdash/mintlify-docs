...
description: "Bulk edit dashboards and charts with AI coding agents through the download-edit-upload workflow"
doc-type: tutorial
---
...
1. [Install Lightdash skills](/workflow/install-agent-skills) for your coding agent
2. Connect your agent to the [Lightdash MCP](/agents/lightdash-mcp) for semantic layer access
3. Ensure the [Lightdash CLI](/workflow/cli/install) is installed and authenticated
...
- [Dashboards as code reference](/workflow/content-as-code) — Full reference for the download and upload commands
- [Agent skills](/workflow/install-agent-skills) — Install skills to help your agent understand Lightdash
- [Lightdash MCP](/agents/lightdash-mcp) — Connect your agent to the semantic layer
