...
For detailed guidance on using agents to edit dashboards—including the recommended workflow for treating files as temporary rather than committing them—see [Editing dashboards with agents](/workflow/edit-dashboards-with-agents).
