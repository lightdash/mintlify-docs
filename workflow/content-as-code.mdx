...
description: "Download your charts, dashboards, spaces, agents, and roles as code, make changes, then upload them back to your Lightdash project with the CLI. Content as code is also how you copy content from an existing project into a new one."
doc-type: reference
---
...
<Frame>
  ![](../images/workflow/content-as-code/download-content-924b51a78c9840990608f3ed81f80b56.jpg)
</Frame>
...
<Tip>
  The examples below are not exhaustive, so if you have additional questions, you can always [reach out to our support team](/help/support) for more details.
</Tip>
...
![](../images/workflow/content-as-code/dashboards-as-code-chart-example.png)
