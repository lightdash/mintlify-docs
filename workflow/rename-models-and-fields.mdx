...
When renaming, a new chart version is created with the new changes. If you make a mistake during renaming, you can restore individual charts by using [version history](/explore/version-history#charts).