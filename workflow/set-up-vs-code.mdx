...
description: Configure YAML validation in VS Code so schema and formatting issues in your Lightdash model, chart, and dashboard files are flagged as you edit.
doc-type: tutorial
tag: "Tutorial"
---
