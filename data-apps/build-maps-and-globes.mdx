---
title: "Build maps and globes in a data app"
sidebarTitle: "Build maps and globes"
...
<Frame>
  <img src="/images/data-apps/build-maps-and-globes/maps-world-view-hero.jpg" alt="A data app showing an interactive d3 globe with countries colored by GDP and a country detail panel for Spain" />
</Frame>
...
The map needs country boundary shapes. Data apps fetch external data through [external connections](/data-apps/external-connections) — a project admin registers the API once, and apps call it through a proxy that pins requests to the registered host.
...
<Frame>
  <img src="/images/data-apps/build-maps-and-globes/maps-connection-wizard.png" alt="The Data app connections settings page with a GeoJSON connection configured" />
</Frame>
...
* **No map tiles / basemap imagery** - tile servers are blocked by the app's content security policy, by design. d3's SVG projections don't need them. For a tile-based scatter or choropleth on a dashboard, use the core [Map chart](/explore/chart-types/map) instead.
