...
<Info>
  **Enterprise only.** Building data apps locally requires data apps (including the build sandbox) to be enabled on your Lightdash instance. See [Self-hosting data apps](/self-host/data-apps) if you run your own instance.
</Info>
