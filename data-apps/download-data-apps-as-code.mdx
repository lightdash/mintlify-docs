...
<Info>
  Building data apps locally is <Badge icon="building-plus" color="blue" size="sm" shape="pill">Enterprise</Badge> and requires data apps, including the build sandbox, to be enabled on your Lightdash instance. See [Self-hosting data apps](/self-host/data-apps) if you run your own instance.
</Info>
