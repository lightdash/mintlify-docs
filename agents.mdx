...
| [AI writeback](/agents/ai-writeback) *(Beta)* | Agent-proposed changes to dbt / Lightdash YAML | Analytics engineer | Feature flag, Git review, dbt / Lightdash validation |
