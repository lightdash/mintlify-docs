...
<a href="https://demo.lightdash.com/projects/d496d901-a76d-4916-9eae-b81bc7337013/dashboards/c24ef37d-6a28-451d-b414-641595684f23/view" target="_blank">
  <Card title="See maps in action" icon="external-link" horizontal>
    Explore an interactive demo dashboard with scatter maps, area maps, and heatmaps.
  </Card>
</a>
...
<Frame>
![map](/images/visualizations/map/intro.png)
</Frame>
...
If a CARTO background displays an "API key required" watermark on a self-hosted instance, ask your administrator to [configure a CARTO Basemaps API key](/self-host/customize-deployment/environment-variables#map-basemaps).

## Scatter maps

<Frame>
![scatter map](/images/visualizations/map/scatter.png)
</Frame>
...
| Background map | None, OpenStreetMap, Light, Dark, Voyager (clean), or Satellite. Choose separate backgrounds for light and dark mode. When set to None, you can set a custom background color. |
| Save current map extent | Preserves zoom and pan position when enabled. |

## Area maps (Choropleth)

<Frame>
![choropleth map](/images/visualizations/map/cloreopath.png)
</Frame>
...
<Frame>
![heatmap](/images/visualizations/map/heatmap.png)
</Frame>
