...
<Frame>
![A sankey diagram: source nodes on the left joined to target nodes on the right by ribbons whose thickness scales with the metric](/images/visualizations/sankey/sankey.png)
</Frame>
