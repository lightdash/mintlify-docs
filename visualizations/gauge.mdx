...
<Frame>
  ![A gauge chart: a semicircular dial with a needle pointing at the current value, and the arc split into coloured bands for the qualitative range](/images/visualizations/gauge/gauge-chart.png)
</Frame>
