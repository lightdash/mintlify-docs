...
<Frame>
  ![A stacked area chart, with several coloured bands piled on top of each other so the outer edge traces the combined total over time](/images/visualizations/area-chart/stacked-area-chart.png)
</Frame>
