...
<Frame>
  ![A table visualization: rows of records with a header row of field names](/images/visualizations/table/table-chart-278753fedbb2530cda566e2fc61cebef.png)
</Frame>
...
<Frame>
  ![A table with the row dimension values down the side, the column dimension values across the top, and a metric in each intersecting cell](/images/visualizations/table/columns-rows-metrics-example-97f2fbed98971241dde62c993fa6df8e.jpg)
</Frame>
...
<Frame>
![Tinybars Config Pn](/images/visualizations/table/tinybars-config.png)
</Frame>
...
<Frame>
  ![A pivoted table where a dimension moved into the column section spreads its values across the header row](/images/visualizations/table/pivoted-table-72daaf2e205221bd425e61dd1b6dc883.jpg)
</Frame>
...
<img
  ...
  src="/images/visualizations/table/pivot_rows_cohort_retention_light.png"
/>
</Frame>
<Frame>
<img
  ...
  src="/images/visualizations/table/pivot_rows_cohort_retention_dark.png"
/>
</Frame>
...
<img
  ...
  className="block dark:hidden"
  src="/images/visualizations/table/pivot_column_limit_example_1_light.png"
/>
</Frame>
<Frame>
<img
  alt="Pivot column limit example"
  className="hidden dark:block"
  src="/images/visualizations/table/pivot_column_limit_example_1_dark.png"
/>
</Frame>
...
<img
  ...
  className="block dark:hidden"
  src="/images/visualizations/table/column_limit_exceeded_light.png"
/>
</Frame>
<Frame>
<img
  alt="Pivot column limit exceeded"
  className="hidden dark:block"
  src="/images/visualizations/table/column_limit_exceeded_dark.png"
/>
</Frame>
...
<img
  alt="Metrics as rows"
  className="block dark:hidden"
  src="/images/visualizations/table/metrics_as_rows_light.png"
/>
</Frame>
<Frame>
<img
  alt="Metrics as rows"
  className="hidden dark:block"
  src="/images/visualizations/table/metrics_as_rows_dark.png"
/>
</Frame>
...
<Frame>
  ![A table of monthly anonymous device counts whose total row is lower than the sum of the values above it](/images/visualizations/table/tables-lower-total-17b9669a5d61613bf9d9a1a800138fd7.png)
</Frame>
...
<Frame>
  ![A table with rows grouped by the first dimension and a subtotal row closing out each group](/images/visualizations/table/subtotals-69de33b7bb4a868d33b713d61002a782.png)
</Frame>
...
<Frame>
![A wide table with the first columns frozen to the left, marked by the lock icon in their headers, while the rest scroll](/images/visualizations/table/table-freeze-column.png)
</Frame>
...
<Frame>
![A column header edge being dragged sideways, widening the column as the neighbouring ones shift](/images/visualizations/table/resize-columns.gif)
</Frame>
...
<Frame>
![The Conditional Formatting section of the Configure tab, with a rule that colours cells meeting its condition](/images/visualizations/table/conditional-formatting-d7ad3652e9381b8bf60b416a110e7760.png)
</Frame>
...
<Frame>
![A conditional formatting rule set to Range, with min and max colour pickers and the table cells shaded along the resulting colour scale](/images/visualizations/table/table-conditional-format-range.png)
</Frame>
