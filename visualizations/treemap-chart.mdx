...
<Frame>
  ![A treemap of one dimension: a rectangle per category, each sized by its metric value](/images/visualizations/treemap-chart/treemap-single-dim.png)
</Frame>

**Two dimensions**: Creates a hierarchy where each rectangle is split into sub-rectangles based on the second dimension.

<Frame>
  ![A treemap of two dimensions, where each top-level rectangle is subdivided into smaller rectangles for the second dimension](/images/visualizations/treemap-chart/treemap-two-dims.png)
</Frame>

**Three or more dimensions**: The chart displays the top-level hierarchy. Users can click to drill down into deeper layers.

<Frame>
  ![A treemap rectangle being clicked, expanding to fill the chart and reveal the next level of the hierarchy](/images/visualizations/treemap-chart/treemap-drilldown.gif)
</Frame>
