...
<Frame>
  ![A mixed chart combining bars and a line on the same axes, with each series drawn in a different chart type](/images/visualizations/mixed-chart/mixed-chart.png)
</Frame>
...
<Frame>
  ![The Series tab of the Configure panel, where each series has its own chart type drop-down set to bar or line](/images/visualizations/mixed-chart/chart-config-mixed.png)
</Frame>
