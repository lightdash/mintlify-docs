...
<Info>
  Custom chart types (from the chart library or Chart Studio) are an enterprise feature and require the [data apps runtime](/self-host/enterprise-features/data-apps) to be enabled.
</Info>
