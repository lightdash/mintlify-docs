...
<Frame>
  ![The Explorer with the chart type menu open and Custom selected beside a stream chart](/images/visualizations/custom-charts/custom-charts-drop-down.png)
</Frame>
...
The fastest way to bring a chart you've configured in Vega-Lite into the newer custom chart type system is to share the Vega-Lite JSON spec and screenshot with the agent in Chart Studio. The agent can then create a fully interactive custom chart type which you can shift any existing charts to.
