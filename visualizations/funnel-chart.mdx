...
<Frame>
  ![A funnel chart: stacked horizontal bands narrowing from top to bottom, each labelled with its stage count and the percentage of the starting count](/images/visualizations/funnel-chart/funnel-chart.png)
</Frame>
...
<Frame>
  ![The funnel chart General settings panel, with controls for which row or column supplies the stages and how labels are shown](/images/visualizations/funnel-chart/funnel-chart-config.png)
</Frame>
