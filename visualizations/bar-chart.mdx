...
<Frame>
  ![A bar chart with one vertical bar per category, each rising from a shared baseline so the heights can be compared directly](/images/visualizations/bar-chart/bar-chart.png)
</Frame>
...
<Frame>
  ![A stacked bar chart where each bar is divided into coloured segments, so the bar height is the total and each segment is one group's share](/images/visualizations/bar-chart/stacked-bar-chart.png)
</Frame>
...
<Frame>
  ![A 100% stacked bar chart where every bar is the same full height and the coloured segments show each group's percentage of that total](/images/visualizations/bar-chart/hundred-stacked-bar-chart.png)
</Frame>
...
<Frame>
![download.png](/images/visualizations/bar-chart/hundred-stacked-bar-chart-config.png)
</Frame>
...
<Frame>
  ![A horizontal bar chart with category labels down the left and bars extending to the right](/images/visualizations/bar-chart/horizontal-bar-chart.png)
</Frame>
