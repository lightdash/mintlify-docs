...
<Frame>
  ![A scatter chart plotting one variable against another, each record a single point](/images/visualizations/scatter-chart/scatter-plot-chart.png)
</Frame>
...
<Frame>
  ![A scatter chart where points are coloured by a third dimension, so each group is a distinct colour](/images/visualizations/scatter-chart/scatter-chart-grouped.png)
</Frame>
