...
<Frame>
  ![A line chart with a single line tracking a metric across dates](/images/visualizations/line-chart/line-chart.png)
</Frame>
...
<Frame>
  ![A line chart with several coloured lines, one per group, plotted over the same date range for comparison](/images/visualizations/line-chart/multi-line-chart.png)
</Frame>
