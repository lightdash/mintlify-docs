...
<Info>
If you need filter interactivity or exploration capabilities, consider using [dashboard embedding](/embed/embed-dashboards) instead or contact us with your use-case.
</Info>
...
Translate embedded charts using the `contentOverrides` prop. See [React SDK localization](/embed/react-sdk#localization) for details.
