...
- At least one metric defined in the project's semantic layer. See [How to create metrics](/get-started/build-your-semantic-layer/create-metrics).
...
<CardGroup cols={2}>
  <Card title="React SDK reference" icon="react" href="/embed/react-sdk#lightdashmetricscatalog">
    Full prop reference for the Lightdash.MetricsCatalog component
  </Card>

  <Card title="Embedding reference" icon="book" href="/embed/reference#metrics-catalog-token">
