...
<Frame>
  ![](../images/embed/embed-create-secret-fbb86d6bcb70f4d004c48adb3c107922.png)
</Frame>
...
For embedding the project [metrics catalog](/get-started/build-your-semantic-layer/create-metrics) so embedded users can browse metrics and, optionally, continue into Explore. See [Embedding the metrics catalog](/embed/embed-metrics-catalog) for the full walkthrough.
...
<Frame>
    ![](../images/embed/reference/embedding-preview-all-filters-bf5d00a3ef24a2370bc5ca56c8785e2d.png)
</Frame>
...
<Frame>
  ![](../images/embed/reference/embedding-settings-some-filters-1658fe2f72623f85dee2eff322833ea8.png)
</Frame>

Will result in some filters in the dashboard for users to interact with:

<Frame>
  ![](../images/embed/reference/embedding-preview-some-filters-9f13263ec3800c3e7f5e6079fa78cd66.png)
</Frame>
...
<Frame>
  ![](../images/embed/reference/embedding-preview-no-filters-ced58145c215a0b17d86b50634a09057.png)
</Frame>
...
<Frame>
  ![](../images/embed/reference/embedding-download-csv-2a4cbcfa350c6cefed880971090c117b.png)
</Frame>
...
<Frame>
  ![](../images/embed/reference/embedding-print-61cb9f9107c6e4ae00fa3cde99dd572d.png)
</Frame>
...
When enabled, the embed renders the dashboard's configured date zoom controls (the Default zoom plus any named controls), letting users change the date granularity of charts on the dashboard. See the [Date zoom guide](/explore/date-zoom) for complete documentation on this feature.
...
<Frame>
  ![](../images/embed/reference/embedding-explore-from-here.png)
</Frame>
...
<Frame>
  ![](../images/embed/reference/embedding-view-underlying-data.png)
</Frame>
...
<Frame>
  ![](../images/embed/embed-add-dashboard-cb6bef5fde69ba9d6eaeb693744d75cc.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="iframe embedding reference" icon="code" href="/embed/iframe">
    URL patterns and HTML embedding details
  </Card>

  <Card title="React SDK reference" icon="react" href="/embed/react-sdk">
    Component API for React integration
  </Card>

  <Card title="Embedding quickstart" icon="rocket" href="/embed/set-up-embedding">
    Get started with embedding in 5 minutes
  </Card>

  <Card title="User attributes" icon="shield-check" href="/workspace-admin/user-attributes">
