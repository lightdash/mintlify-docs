...
- An AI agent configured in your Lightdash project. See [Getting started with AI agents](/agents/set-up-agents).
...
<CardGroup cols={2}>
  <Card title="AI agents overview" icon="robot" href="/agents">
    Learn how to design and configure agents before embedding them
  </Card>

  <Card title="React SDK reference" icon="react" href="/embed/react-sdk#lightdashaiagent">
    Full prop reference for the Lightdash.AiAgent component
  </Card>

  <Card title="Embedding reference" icon="book" href="/embed/reference#ai-agent-token">
    Complete JWT structure for AI agent embed tokens
  </Card>

  <Card title="Write actions" icon="pen-to-square" href="/embed/reference#write-actions">
