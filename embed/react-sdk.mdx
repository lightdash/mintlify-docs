...
Embed the Lightdash [metrics catalog](/get-started/build-your-semantic-layer/create-metrics) so embedded users can browse the metrics defined in a project, preview them, and — when the JWT allows it — continue into Explore without leaving your app.
...
| `ld-dashboard-guided-setup`        | The guided setup card shown while [required filters or requirement groups](/explore/filter-your-data#required-filters-and-filter-requirement-groups) are unmet |
