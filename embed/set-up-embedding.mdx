---
title: "Set up embedding"
sidebarTitle: "Set up embedding"
description: Generate expirable URLs and tokens to serve Lightdash content to users in your own application
doc-type: tutorial
---
...
<Frame>
  <img src="/images/embed/embed-create-secret-fbb86d6bcb70f4d004c48adb3c107922.png" alt="Project settings on the Embed configuration tab, showing an empty &quot;No embed secret&quot; state with a Generate embed secret button" />
</Frame>
...
<Frame>
  <img src="/images/embed/embed-add-dashboard-cb6bef5fde69ba9d6eaeb693744d75cc.png" alt="The Allowed dashboards card with its dashboard picker open, listing two selectable dashboards" />
</Frame>
...
<Frame>
  <img src="/images/embed/set-up-embedding/embed-preview-6add607fe9348ed49483ae487235bd50.png" alt="The Preview panel with a dashboard selected, a one-hour expiry, an empty user attributes row, and Preview and Generate &amp; copy URL buttons" />
</Frame>
...
<Frame>
  <img src="/images/embed/set-up-embedding/embed-developer-dcdab9d9082069f5ade377284254319c.png" alt="The Code snippet panel showing NodeJS and Python tabs, with NodeJS code that signs a dashboard JWT and builds the embed URL" />
</Frame>
