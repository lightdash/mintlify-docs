...
<Frame>
  <img src="../images/embed/set-up-embedding/embed-cors-settings.png" alt="CORS settings panel showing regex and exact origin entries" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Embedding AI agents" icon="robot" href="/embed/embed-ai-agents">
    Let customers chat with their data inside your application
  </Card>

  <Card title="Embedding the metrics catalog" icon="list" href="/embed/embed-metrics-catalog">
    Let customers browse and explore project metrics from your app
  </Card>

  <Card title="Embedding data apps" icon="sparkles" href="/embed/embed-data-apps">
