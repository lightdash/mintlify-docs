...
<CardGroup cols={2}>
  <Card title="Embedding reference" icon="book" href="/embed/reference#dashboard-token">
    Complete JWT structure and every interactivity option
  </Card>

  <Card title="iframe embedding reference" icon="code" href="/embed/iframe">
    URL patterns, theming, sizing, and token refresh
  </Card>

  <Card title="React SDK reference" icon="react" href="/embed/react-sdk">
    Props, programmatic filters, styling, and edit mode
  </Card>
