...
description: "Embed a dashboard with filters, exports, and interactive tiles via iframe or React SDK"
doc-type: tutorial
---
...
By default, dashboard interactivity is controlled by fields nested inside the JWT `content` object: filters, parameters, exports, date zoom, Explore, underlying data, and data app tiles. To manage capabilities through the actor's role, follow [Permission modes](/embed/reference#permission-modes). Adding a `writeActions` claim also lets viewers save charts from Explore or edit and build dashboards through the SDK.
