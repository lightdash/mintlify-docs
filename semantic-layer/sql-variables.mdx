---
title: "SQL variables"
description: "Reference variables that template the SQL in your models and make it reusable"
doc-type: reference
---
...
<Info>
  **The user email attribute is only available when the email is verified.**
  ...
  <Frame>
    ![Red error toast reading "Error running query: missing user attribute email on sql_filter"](/images/user-attributes-info.png)
  </Frame>
  ```yaml
  models:
    - name: example
