...
<Info>
**Availability:** Custom granularities are a [Beta](/support/feature-maturity-levels) feature.
</Info>
...
<Info>
  **Experimental:** The `convert_timezone` dimension override is currently in the [Experimental](/support/feature-maturity-levels) phase. Contact support to enable it for your organization. Has no effect unless the [project query timezone](/workspace-admin/set-project-timezone#configure-your-project-timezone) is set.
</Info>
