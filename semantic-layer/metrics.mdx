...
<Info>
  **Experimental:** Post calculation metrics are currently in the Experimental phase. Learn what this means in our Feature Maturity Levels guide: [Feature Maturity Levels](/support/feature-maturity-levels).
</Info>
...
<Warning>
  **Beta:** `sum_distinct` is currently in Beta. Learn what this means in our Feature Maturity Levels guide: [Feature Maturity Levels](/support/feature-maturity-levels).
</Warning>
...
<Warning>
  **Beta:** `average_distinct` is currently in Beta. Learn what this means in our Feature Maturity Levels guide: [Feature Maturity Levels](/support/feature-maturity-levels).
</Warning>
...
<Frame>
  ![](../images/underlying-data-ec265ef84085672491f477d180d173bc.jpg)
</Frame>
...
<Note>
Hidden dimensions (with `hidden: true`) cannot be included in drilldowns. If you need a dimension to appear in drilldowns but not in the Explore sidebar, consider using [groups](/semantic-layer/dimensions#groups) to organize dimensions instead.
</Note>
