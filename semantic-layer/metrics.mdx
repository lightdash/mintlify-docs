...
<Info>
  **Experimental:** Post calculation metrics are currently in the Experimental phase. Learn what this means in our Feature Maturity Levels guide: [Feature Maturity Levels](/help/feature-maturity-levels).
</Info>
...
<Warning>
  **Beta:** `sum_distinct` is currently in Beta. Learn what this means in our Feature Maturity Levels guide: [Feature Maturity Levels](/help/feature-maturity-levels).
</Warning>
...
<Warning>
  **Beta:** `average_distinct` is currently in Beta. Learn what this means in our Feature Maturity Levels guide: [Feature Maturity Levels](/help/feature-maturity-levels).
</Warning>
