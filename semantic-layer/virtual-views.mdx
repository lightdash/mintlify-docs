---
title: "Virtual views"
description: "Turn a custom SQL query into a reusable table in Lightdash. Build a virtual view in the SQL Runner, explore and join it like any dbt table, and manage it as code."
doc-type: reference
---
