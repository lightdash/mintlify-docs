...
- Model-level metrics in a pre-aggregate grouped by a repeated-column field have a [known correctness limitation](/semantic-layer/nested-and-repeated-columns#pre-aggregates).
