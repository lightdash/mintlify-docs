---
title: "Explores"
sidebarTitle: "Explores"
description: Curate multiple ways to query the same table for different audiences
doc-type: reference
---
...
[📚 Read the Tables reference docs for all configuration options](/semantic-layer/tables#table-properties)
...
Explore-scoped `additional_dimensions` support the same properties as [column-level additional dimensions](/semantic-layer/dimensions#additional-dimensions):
