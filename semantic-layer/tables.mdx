...
Tables configuration filters models after Lightdash compiles them. To skip compilation for models entirely — which speeds up syncing on large projects — use the [dbt selector](/semantic-layer/dbt/projects#dbt-selector) in your project settings instead.
...
| group_label                                               | string             | **Deprecated:** use [`groups`](#groups) instead. Group tables in the sidebar.                                                            |
...
<Frame>
  ![](../images/semantic-layer/tables/table-group-label-a6d42e6d72a08f15c392fb7cb03a2e6a.png)
</Frame>
