...
|----------|----------------|
| You already have a dbt project | Use the standard [dbt integration](/semantic-layer/dbt/projects) |
...
<Steps>
  ...
  <Step title="Install Lightdash skills">
    Run [`lightdash install-skills`](/get-started/build-your-semantic-layer/install-skills) to teach your coding agent everything it needs to know about building in Lightdash, from writing YAML models to creating metrics and deploying.
...
Lightdash YAML uses the same syntax as the [Lightdash semantic layer in dbt](/semantic-layer/dbt/projects), but instead of nesting everything under `meta` tags, all configuration is at the top level of the file.
...
# Metric definitions
# For more configuration see: https://docs.lightdash.com/semantic-layer/metrics
metrics:
  user_count:
    type: count_distinct
    sql: ${TABLE}.USER_ID
...
# For more configuration see: https://docs.lightdash.com/semantic-layer/dimensions
dimensions:
...
1. **Install Lightdash skills:** Run [`lightdash install-skills`](/get-started/build-your-semantic-layer/install-skills) to give your coding agent everything it needs to build YAML models, create metrics, and deploy to Lightdash. Then ask your agent to create your YAML files, add some metrics, and deploy to Lightdash.
...
- [Explore your data](/get-started/explore-your-data/use-explores) in the Lightdash UI
- [Create metrics](/get-started/build-your-semantic-layer/create-metrics) to define your key business calculations
