...
You can adjust which tables show up in the Tables list by adjusting your tables configuration under project settings, [read the guide here](/get-started/build-your-semantic-layer/add-tables-to-lightdash#configuring-which-tables-appear-in-your-lightdash-project).
