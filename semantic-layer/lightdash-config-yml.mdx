...
See the [Parameters guide](/semantic-layer/parameters) for more information on how to use parameters.
...
| :------------ | :---------- |
| `date_zoom`   | The currently selected [date zoom](/explore/date-zoom) granularity, lowercased (e.g. `day`, `week`, `month`). Empty string when no date zoom is selected. |

If you define a user parameter with one of these names, your user parameter shadows the reserved one. See [Reserved parameters](/semantic-layer/parameters#reserved-parameters) for usage details.
