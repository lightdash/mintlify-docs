---
title: "Upgrading dbt"
description: "What changes in your Lightdash setup when you move between dbt versions"
---
...
<Note>
  Lightdash works with dbt Core v2. If your project builds on Fusion, Lightdash compiles it the same way it compiles earlier versions — see [dbt projects](/semantic-layer/dbt/projects) for connection settings.
</Note>
