...
[Read how to do that and check out our example workflow files](/workflow/cli/deploy#automatically-deploy-your-changes-to-lightdash-using-a-github-action).
...
You can filter out models in your dbt project that you don't want to see in Lightdash. This is useful if you have a large dbt project and you want to speed up the sync process. Unlike [table selection](/get-started/build-your-semantic-layer/add-tables-to-lightdash#limiting-the-tables-in-lightdash-using-dbt-tags), this selector is applied to the dbt models, so it will skip the entire compilation process for the models that you don't want to see in Lightdash.
