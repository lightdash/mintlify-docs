...
![](../../images/semantic-layer/dbt/write-back/write-back-metrics.jpg)
...
![](../../images/semantic-layer/dbt/write-back/refresh-after-write-back.jpg)
...
1. Click `Write back to dbt`
   ...
   ![](../../images/semantic-layer/dbt/write-back/write-back-custom-dimension-1.png)
2. Preview the Dimension YAML and open a pull request.

   ![](../../images/semantic-layer/dbt/write-back/write-back-custom-dimension-2.png)
3. Approve and merge the pull request in your dbt project.

   ![](../../images/semantic-layer/dbt/write-back/write-back-custom-dimension-3.png)
...
<Frame>
  ![](/images/semantic-layer/dbt/write-back/dbt-write-back-3774e219cdb58ad09a5e290b28e8b427.jpg)
</Frame>
...
<Frame>
  ![](/images/semantic-layer/dbt/write-back/write-back-pull-request-5c36c33617a258728a644d1e76896725.jpg)
</Frame>
...
<Frame>
  ![](/images/semantic-layer/dbt/write-back/tables-configuration-write-back-c4be0ae3c4c13aab3c93a81e4956cd4d.jpg)
</Frame>
...
<Frame>
  ![](../../images/semantic-layer/dbt/write-back/dbt-cloud-run-automatically-561d3a59b2dc47a003adaf926fbe5a3b.jpg)
</Frame>