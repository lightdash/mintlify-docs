...
2. Use Lightdash's [MetaMove CLI](https://docs.lightdash.com/semantic-layer/dbt/migrate-to-1-10#automated-migration-with-metamove) to automatically migrate `meta` and `tags` from top-level properties to `config` blocks.
