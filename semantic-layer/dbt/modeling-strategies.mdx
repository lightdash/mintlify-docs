...
Lightdash handles multi-join explores well technically, and [fanout protection](/semantic-layer/joins#many-to-many-or-one-to-many-with-fanout-protection) ensures accuracy. However, looking at a page with many joined tables can be overwhelming for business users who aren't familiar with the data model.
