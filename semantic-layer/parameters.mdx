...
description: "Parameters are variables users can set at runtime to build dynamic, reusable queries in Lightdash without writing SQL."
doc-type: reference
---
...
6. **Table Calculations**: Use parameters in [table calculations](/explore/create-table-calculations)
