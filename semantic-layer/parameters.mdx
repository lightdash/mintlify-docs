...
For a complete list of all available parameter configuration options, see the [parameters configuration table](/semantic-layer/tables#parameters-configuration).
...
For a complete reference of project-level parameter properties and options, see the [lightdash.config.yml reference](/semantic-layer/lightdash-config-yml#parameters-configuration).
...
For a complete reference of model-level parameter properties and options, see the [tables reference](/semantic-layer/tables#parameters-configuration).
