...
- Queries with [Parameters](/semantic-layer/lightdash-config-yml#parameters-configuration), [user attributes](/workspace-admin/user-attributes) inside SQL, or [`sql_filter`](/semantic-layer/tables#sql-filter-row-level-security)
