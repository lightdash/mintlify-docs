...
description: "What each maturity level means for the stability and availability of a Lightdash feature"
sidebarTitle: "Feature maturity levels"
---

Maturity is how stable a feature is. It is a separate question from [availability](/support/feature-availability), which is who can reach the feature — a Beta feature can be available to everyone, and a GA feature can still need an Enterprise plan.
